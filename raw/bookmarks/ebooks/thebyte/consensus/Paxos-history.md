---
title: " 6.3.1 Paxos 算法起源"
source: thebyte
url: "https://www.thebyte.com.cn/consensus/Paxos-history.html"
---
...
1990 年，Lamport 将《The Part-Time Parliament》论文提交给 TOCS 期刊。根据 Lamport 的本人的回忆[[1]](#footnote1)，TOCS 审稿人阅读后认为“这篇论文不怎么重要，但还有些意思”，并建议删掉与 Paxos 相关的故事背景。Lamport 对这些缺乏幽默感的审稿人颇为不爽，拒绝对论文进行修改。于是，论文的发表被搁置。
...
《The Part-Time Parliament》[[2]](#footnote2) 论文最终在 1998 年公开发表。

《The Part-Time Parliament》论文发表之后，还是有很多人抱怨看不懂，人们只记住了那个奇怪的故事，而不是 Paxos 算法。Lamport 走到哪都要被人抱怨一通。于是他忍无可忍，在 2001 年使用计算机领域的概念重新描述了一遍算法，发表了论文 《Paxos Made Simple》[[3]](#footnote3)。

这是一篇很短的论文，摘要只有一句话：“The Paxos algorithm, when presented in plain English, is very simple.”！语气完全无法掩盖作者对 Paxos 的策略没有奏效的失望。

![image](../images/consensus_Paxos-history_img00.png)
 
 图 6-4 《Paxos Made Simple》论文摘要

然而，这篇论文还是非常难以理解，引用斯坦福大学学者 Diego Ongaro 和 John Ousterhout 在设计 Raft 时的论文[[4]](#footnote4)中对 Paxos 的描述。
...
参见 https://lamport.azurewebsites.net/pubs/pubs.html#lamport-paxos [↩︎](#footnote-ref1)

参见 https://lamport.azurewebsites.net/pubs/lamport-paxos.pdf [↩︎](#footnote-ref2)

参见 https://lamport.azurewebsites.net/pubs/paxos-simple.pdf [↩︎](#footnote-ref3)

参见 https://raft.github.io/raft.pdf [↩︎](#footnote-ref4)