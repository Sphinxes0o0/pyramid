...
2015 年，Pivotal[[1]](#footnote1) 公司的技术产品经理 Matt Stine 首次提出了“云原生”（Cloud Native）的概念。
在 Matt Stine 所著的《迁移到云原生应用架构》书中，他提出云原生架构应该具备 5 个主要特征，如图 1-8 所示。
:::
![](/assets/pivotal-cloud-native-Dykm0_0G.svg)
图 1-8 云原生架构的早期特征
:::
...
:::
![](/assets/pivotal-cloud-native-update-BbDnAOoK.svg)
图 1-9 Matt Stine 更新后的云原生架构特征
:::
现在，在 Pivotal 官方网站中[[2]](#footnote2)，对云原生的介绍则是关注如图 1-10 所示的 4 个要点：DevOps（开发运维）、Continuous Delivery（持续交付）、Microservices（微服务）、Containers（容器化），这也是大家最熟悉的版本。
:::
![](/assets/cloud-native-BQcsW1Yq.png)
...
随着社区对云原生理念的广泛认可和云原生生态的不断扩大，还有 CNCF 项目和会员的大量增加，起初的定义已经不再适用，因此 CNCF 对云原生进行了重新定位。2018 年 6 月，CNCF 正式对外公布云原生定义 v1.0 版本[[3]](#footnote3)。
:::
CNCF 云原生的定义 v1.0 版本
...
:::
![](/assets/cncf-cloud-native-BQySTAOb.svg)
...
- 
Pivotal 是云原生概念提出的鼻祖，还推出了 Pivotal Cloud Foundry 和 Spring 系列开发框架，是行业先驱和探路者。2019 年，Pivotal 被 VMware 收购。 [↩︎](#footnote-ref1)
- 
参见 https://pivotal.io/cloud-native [↩︎](#footnote-ref2)
- 
参见 https://github.com/cncf/toc/blob/main/DEFINITION.md [↩︎](#footnote-ref3)
:::