...
下一步呢？ 对了，找cmd\_objcopy。这次定义的地方稍有不同，不在scripts/Makefile.build，而是在scripts/Makefile.lib。
...
怎么样，现在是不是驾轻就熟了。看到这个也基本能够猜出个八九不离十。setup.elf是由$(SETUP\_OBJS)链接而成的。嗯，没想到这么简单，白白浪费了我这么气势磅礴的一个标题了。

为了弥补点什么，咱把SETUP\_OBJS的内容也给大家展开了。
