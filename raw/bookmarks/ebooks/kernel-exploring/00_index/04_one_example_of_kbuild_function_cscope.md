...
方才我们学习了史上最简单[可能是kbuild中最直接的小目标 – help](/kernel-exploring/00_index/03_first_target_help.md)。这次我们来看看稍微高级那么一点点的目标 -- cscope。
...
不过后面这个$(call cmd,tags)是什么鬼？原来这是makefile中定义函数的一种方式。我们来看一下手册中是怎么讲的， [GNU make: call function](https://www.gnu.org/software/make/manual/html_node/Call-Function.html)
...
最新6.7的版本又看了下，现在忽略生成cscope的方式改变了。现在是通过环境变量IGNORE\_DIRS来指定需要忽略的路径。
