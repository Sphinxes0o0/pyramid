...
![这里写图片描述](/files/-LcGhm_h2CkOmi2HVqMh)
...
![这里写图片描述](/files/-LcGhm8iPj05W00K3IEO)
...
![这里写图片描述](/files/-LcGhmD10lrNWMazYC1p)

而出于某些原因，内核只留下了\_text到\_brk\_end这段空间的映射。其余的映射都清零了。
...
![这里写图片描述](/files/-LcGhmaDnasQG6LjuINy)

所有的准备工作做完，最后又切换了一次。从early\_level4\_pgt切换到了init\_level4\_pgt。对了，这个就是那个init进程的空间了。
