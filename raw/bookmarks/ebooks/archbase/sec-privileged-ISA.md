# [第 3 章]{.header-section-number} 特权指令系统

## [3.1]{.header-section-number} 特权指令系统简介

在计算机系统层次结构中，应用层[^3^](#fn3){#fnref3 .footnote-ref}在操作系统层之上，只能看到和使用指令系统的一个子集，即指令系统的用户态部分。每个应用程序都有自己的寄存器、内存空间以及可执行的指令。现代计算机的指令系统在用户态子集之外还定义了操作系统核心专用的特权态部分，我们称之为特权指令系统。
...
[3.3](sec-privileged-ISA.html#sec-memory-management)节将对存储管理做更详细的介绍。
...
[3.2](sec-privileged-ISA.html#sec-exception)节将对异常与中断做更详细的介绍。
...
::: tabwid
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [助记符]{.cl-24d0e74c}     | [编号]{.cl-24d0e74c}         | [说明]{.cl-24d0e74c}                                                       |
+============================+==============================+============================================================================+
| [CRMD]{.cl-24d0e760}       | [Ox0]{.cl-24d0e760}          | [处理器当前运行模式及地址翻译模式、全局中断使能等配置信息。]{.cl-24d0e760} |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [PRMD]{.cl-24d0e760}       | [0x1]{.cl-24d0e760}          | [触发当前普通异常的现场的运行模式及全局中断使能等配置信息]{.cl-24d0e760}   |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [EUEN]{.cl-24d0e760}       | [0x2]{.cl-24d0e760}          | [扩展部件的使能控制]{.cl-24d0e760}                                         |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [MISC]{.cl-24d0e760}       | [0x3]{.cl-24d0e760}          | [各权限等级下是否运行使用部分特权指令等杂项配置]{.cl-24d0e760}             |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [ECFG]{.cl-24d0e760}       | [0x4]{.cl-24d0e760}          | [局部中断使能、异常入口间距等配置信息]{.cl-24d0e760}                       |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [ESTAT]{.cl-24d0e760}      | [0x5]{.cl-24d0e760}          | [记录异常和中断发生原因]{.cl-24d0e760}                                     |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [ERA]{.cl-24d0e760}        | [0x6]{.cl-24d0e760}          | [普通异常处理返回地址]{.cl-24d0e760}                                       |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [BADV]{.cl-24d0e760}       | [0x7]{.cl-24d0e760}          | [记录触发地址相关异常的访存虚地址]{.cl-24d0e760}                           |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [BADI]{.cl-24d0e760}       | [0x8]{.cl-24d0e760}          | [记录触发异常指令的指令编码]{.cl-24d0e760}                                 |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [EENTRY]{.cl-24d0e760}     | [0xC]{.cl-24d0e760}          | [配置普通异常处理程序入口地址]{.cl-24d0e760}                               |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [TLBIDX]{.cl-24d0e760}     | [0x10]{.cl-24d0e760}         | [存储管理（TLB）相关寄存器，将在第3节进行详细介绍]{.cl-24d0e760}           |
+----------------------------+------------------------------+                                                                            |
| [TLBEHI]{.cl-24d0e760}     | [0x11]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBELO0]{.cl-24d0e760}    | [0x12]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBELO1]{.cl-24d0e760}    | [0x13]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [ASID]{.cl-24d0e760}       | [0x18]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [STLBPS]{.cl-24d0e760}     | [0x1E]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [PGDL]{.cl-24d0e760}       | [0x19]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [PGDH]{.cl-24d0e760}       | [0x1A]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [PGD]{.cl-24d0e760}        | [0x1B]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [PWCL]{.cl-24d0e760}       | [0x1C]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [PWCH]{.cl-24d0e760}       | [0x1D]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [SAVEn]{.cl-24d0e760}      | [0x30+n]{.cl-24d0e760}       | [保存临时数据]{.cl-24d0e760}                                               |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [TID]{.cl-24d0e760}        | [0x40]{.cl-24d0e760}         | [恒定频率计时器和定时器相关寄存器]{.cl-24d0e760}                           |
+----------------------------+------------------------------+                                                                            |
| [TCFG]{.cl-24d0e760}       | [0x41]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TVAL]{.cl-24d0e760}       | [0x42]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [CNTC]{.cl-24d0e760}       | [0x43]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TICLR]{.cl-24d0e760}      | [0x44]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [LLBCTL]{.cl-24d0e760}     | [0x60]{.cl-24d0e760}         | [LLBit的控制]{.cl-24d0e760}                                                |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [TLBRENTRY]{.cl-24d0e760}  | [0x88]{.cl-24d0e760}         | [TLB重填异常处理专用寄存器]{.cl-24d0e760}                                  |
+----------------------------+------------------------------+                                                                            |
| [TLRBBADV]{.cl-24d0e760}   | [0x89]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBERA]{.cl-24d0e760}     | [0x8A]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBRSAVE]{.cl-24d0e760}   | [0x8B]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBRELO0]{.cl-24d0e760}   | [0x8C]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBRELO1]{.cl-24d0e760}   | [0x8D]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBREHI]{.cl-24d0e760}    | [0x8E]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [TLBRPRMD]{.cl-24d0e760}   | [0x8F]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [MERRCTL]{.cl-24d0e760}    | [0x90]{.cl-24d0e760}         | [由Cache校验错所引发的机器错误异常的相关控制状态寄存器]{.cl-24d0e760}      |
+----------------------------+------------------------------+                                                                            |
| [MERRINFO1]{.cl-24d0e760}  | [0x91]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [MERRINFO2]{.cl-24d0e760}  | [0x92]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [MERRENTRY]{.cl-24d0e760}  | [0x93]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [MERRERA]{.cl-24d0e760}    | [0x94]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [MERRSAVE]{.cl-24d0e760}   | [0x95]{.cl-24d0e760}         |                                                                            |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [DMW0\~DMW3]{.cl-24d0e760} | [0x180\~0x183]{.cl-24d0e760} | [直接映射配置窗口0～3的配置寄存器]{.cl-24d0e760}                           |
+----------------------------+------------------------------+----------------------------------------------------------------------------+
| [DBG]{.cl-24d0e760}        | [0x500]{.cl-24d0e760}        | [调试相关的控制状态寄存器]{.cl-24d0e760}                                   |
+----------------------------+------------------------------+                                                                            |
| [DERA]{.cl-24d0e760}       | [0x501]{.cl-24d0e760}        |                                                                            |
+----------------------------+------------------------------+                                                                            |
| [DSAVE]{.cl-24d0e760}      | [0x502]{.cl-24d0e760}        |                                                                            |
+----------------------------+------------------------------+----------------------------------------------------------------------------+

: [表 3.1: ]{#tab:la-csr}LoongArch处理器的控制寄存器 {.cl-24d6eb9c}


控制状态寄存器虽然重要，但对其操作的频率通常远远低于通用寄存器，所以指令系统中通常不会设计针对控制状态寄存器的访存和复杂运算指令。不过大多数指令系统至少会定义若干在控制状态寄存器和通用寄存器之间进行数据搬运的指令，从而可以将数据移动到通用寄存器中进行相关处理，或者进一步将处理结果写回控制状态寄存器中。在LoongArch指令系统中，就定义了CSRRD和CSRWR指令来完成控制状态寄存器的读写操作。例如，指令"csrrd \$t0, CSR_CRMD[^4^](#fn4){#fnref4 .footnote-ref}"将控制状态寄存器CRMD的值读出，然后写入通用寄存器\$t0中；指令"csrwr \$t0, CSR_CRMD"将通用寄存器\$t0中的值写入到控制状态寄存器CRMD中，同时将控制状态寄存器CRMD的旧值写入通用寄存器\$t0中。

## [3.2]{.header-section-number} 异常与中断

计算机通常按照软件的执行流进行顺序执行和跳转，但有时会需要中断正常的执行流程去处理其他任务，可以触发这一过程的事件统称为异常。

### [3.2.1]{.header-section-number} 异常分类

从来源来看，异常可分为以下6种。

1）外部事件：来自CPU核外部[^5^](#fn5){#fnref5 .footnote-ref}的事件，来自处理器内部其他模块或者处理器外部的真实物理连线也称为中断。中断的存在使得CPU能够异步地处理多个事件。在操作系统中，为了避免轮询等待浪费CPU时间，与IO相关的任务通常都会用中断方式进行处理。中断事件的发生往往是软件不可控制的，因此需要一套健全的软硬件机制来防止中断对正常执行流带来影响。
...
::: tabwid
+--------------------------+--------------------------------------------------+---------------------------------------------+------------------------------------+
| [异常代号]{.cl-24f4786a} | [异常编号]{.cl-24f4786a}                         | [异常说明]{.cl-24f4786a}                    | [所属异常类别]{.cl-24f4786a}       |
|                          +-----------------------+--------------------------+                                             |                                    |
|                          | [Ecode]{.cl-24f4786a} | [Esubcode]{.cl-24f4786a} |                                             |                                    |
+==========================+=======================+==========================+=============================================+====================================+
| [PIL]{.cl-24f47874}      | [0x1]{.cl-24f47874}   | []{.cl-24f47874}         | [load操作页无效异常]{.cl-24f47874}          | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PIS]{.cl-24f47874}      | [0x2]{.cl-24f47874}   | []{.cl-24f47874}         | [store操作页无效异常]{.cl-24f47874}         | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PIF]{.cl-24f47874}      | [0x3]{.cl-24f47874}   | []{.cl-24f47874}         | [取指操作页无效异常]{.cl-24f47874}          | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PME]{.cl-24f47874}      | [0x4]{.cl-24f47874}   | []{.cl-24f47874}         | [页修改异常]{.cl-24f47874}                  | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PNR]{.cl-24f47874}      | [0x5]{.cl-24f47874}   | []{.cl-24f47874}         | [页不可读异常]{.cl-24f47874}                | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PNX]{.cl-24f47874}      | [0x6]{.cl-24f47874}   | []{.cl-24f47874}         | [页不可执行异常]{.cl-24f47874}              | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [PPI]{.cl-24f47874}      | [0x7]{.cl-24f47874}   | []{.cl-24f47874}         | [页权限等级不合规异常]{.cl-24f47874}        | [地址转换异常]{.cl-24f47874}       |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [ADEF]{.cl-24f47874}     | [0x8]{.cl-24f47874}   | [0x0]{.cl-24f47874}      | [取指地址错异常]{.cl-24f47874}              | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+                       +--------------------------+---------------------------------------------+------------------------------------+
| [ADEM]{.cl-24f47874}     |                       | [0x1]{.cl-24f47874}      | [访存指令地址错异常]{.cl-24f47874}          | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [ALE]{.cl-24f47874}      | [0x9]{.cl-24f47874}   | []{.cl-24f47874}         | [地址非对齐异常]{.cl-24f47874}              | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [BCE]{.cl-24f47874}      | [0xA]{.cl-24f47874}   | []{.cl-24f47874}         | [边界约束检查错异常]{.cl-24f47874}          | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [SYS]{.cl-24f47874}      | [0xB]{.cl-24f47874}   | []{.cl-24f47874}         | [系统调用异常]{.cl-24f47874}                | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [BRK]{.cl-24f47874}      | [0xC]{.cl-24f47874}   | []{.cl-24f47874}         | [断点异常]{.cl-24f47874}                    | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [INE]{.cl-24f47874}      | [0xD]{.cl-24f47874}   | []{.cl-24f47874}         | [指令不存在异常]{.cl-24f47874}              | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [IPE]{.cl-24f47874}      | [0xE]{.cl-24f47874}   | []{.cl-24f47874}         | [指令权限等级错异常]{.cl-24f47874}          | [指令执行中的错误]{.cl-24f47874}   |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [FPD]{.cl-24f47874}      | [0xF]{.cl-24f47874}   | []{.cl-24f47874}         | [浮点指令未使能异常]{.cl-24f47874}          | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [SXD]{.cl-24f47874}      | [0x10]{.cl-24f47874}  | []{.cl-24f47874}         | [128位向量扩展指令未使能异常]{.cl-24f47874} | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [ASXD]{.cl-24f47874}     | [0x11]{.cl-24f47874}  | []{.cl-24f47874}         | [256位向量扩展指令未使能异常]{.cl-24f47874} | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [FPE]{.cl-24f47874}      | [0x12]{.cl-24f47874}  | [0x0]{.cl-24f47874}      | [基础浮点指令异常]{.cl-24f47874}            | [需要软件修正的运算]{.cl-24f47874} |
+--------------------------+                       +--------------------------+---------------------------------------------+------------------------------------+
| [VFPE]{.cl-24f47874}     |                       | [0x1]{.cl-24f47874}      | [向量浮点指令异常]{.cl-24f47874}            | [需要软件修正的运算]{.cl-24f47874} |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [WPEF]{.cl-24f47874}     | [0x13]{.cl-24f47874}  | [0x0]{.cl-24f47874}      | [取指监测点异常]{.cl-24f47874}              | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+                       +--------------------------+---------------------------------------------+------------------------------------+
| [WPEM]{.cl-24f47874}     |                       | [0x1]{.cl-24f47874}      | [load/store操作监测点异常]{.cl-24f47874}    | [系统调用和陷入]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+
| [INT]{.cl-24f47874}      | []{.cl-24f47874}      | []{.cl-24f47874}         | [中断]{.cl-24f47874}                        | [外部事件]{.cl-24f47874}           |
+--------------------------+                       +--------------------------+---------------------------------------------+------------------------------------+
| [TLBR]{.cl-24f47874}     |                       | []{.cl-24f47874}         | [TLB重填异常]{.cl-24f47874}                 | [地址转换异常]{.cl-24f47874}       |
+--------------------------+                       +--------------------------+---------------------------------------------+------------------------------------+
| [MERR]{.cl-24f47874}     |                       | []{.cl-24f47874}         | [机器错误异常]{.cl-24f47874}                | [数据完整性问题]{.cl-24f47874}     |
+--------------------------+-----------------------+--------------------------+---------------------------------------------+------------------------------------+

: [表 3.2: ]{#tab:exception}LoongArch指令系统的异常一览表 {.cl-24fa3e6c}


### [3.2.2]{.header-section-number} 异常处理

#### [3.2.2.1]{.header-section-number} 异常处理流程

异常处理的流程包括异常处理准备、确定异常来源、保存执行状态、处理异常、恢复执行状态并返回等。主要内容是确定并处理异常，同时正确维护上下文环境。异常处理是一个软硬件协同的过程，通常CPU硬件需要维护一系列控制状态寄存器（域）以用于软硬件之间的交互。LoongArch指令系统中与异常（含中断）处理相关的控制状态寄存器格式如图[3.2](sec-privileged-ISA.html#fig:ex-csr)所示。

![LoongArch异常处理相关控制状态寄存器](images/chapter3/csr.png){width="100%"}
...
#### [3.2.2.2]{.header-section-number} 异常嵌套
...
### [3.2.3]{.header-section-number} 中断

异常处理的流程是通用的，但有两类异常出现的机会确实比其他类型大很多。一类是地址转换异常，当片内从虚地址到物理地址的地址转换表不包含访问地址时，就会产生缺页异常，在[3.3](sec-privileged-ISA.html#sec-memory-management)节中我们将进行详细介绍。另一类常见的异常就是中断，中断在外部事件想要获得CPU注意时产生。由于外部事件的不可控性，中断处理所用的时间较为关键。在嵌入式系统中，CPU的主要作用之一就是处理外设相关事务，因此中断发生的数量很多且非常重要。本节以LoongArch指令系统为例介绍中断相关的重要内容。

#### [3.2.3.1]{.header-section-number} 中断传递机制
...
#### [3.2.3.2]{.header-section-number} 向量化中断

LoongArch指令系统默认支持向量化中断[^8^](#fn8){#fnref8 .footnote-ref}，其13个线中断各自具有独立的中断处理程序入口地址。在LoongArch指令系统中，中断被视作一类特殊的异常进行处理，因此在具体计算中断处理程序入口地址时将SWI0～IPI这13个中断依次"视作"异常编号64～76的异常，用异常处理程序入口地址的统一计算方式进行计算。向量化中断的好处之一是省去了中断处理程序开头处识别具体中断源的开销，可以进一步加速中断的处理。
...
#### [3.2.3.3]{.header-section-number} 中断的优先级
...
#### [3.2.3.4]{.header-section-number} 中断使能控制位的原子修改
...
## [3.3]{.header-section-number} 存储管理
...
### [3.3.1]{.header-section-number} 存储管理的原理
...
在32位系统中，采用4KB页时，单个完整页表需要1M项，对每个进程维护页表需要相当可观的空间代价，因此页表只能放在内存中。若每次进行地址转换时都需要先查询内存，则会对性能产生明显的影响。为了提高页表访问的速度，现代处理器中通常包含一个转换后援缓冲器（Translation Lookaside Buffer，简称TLB）来实现快速的虚实地址转换。TLB也称页表缓存或快表，借由局部性原理，存储当前处理器中最经常访问页的页表。一般TLB访问与Cache访问同时进行，而TLB也可以被视为页表的Cache。TLB中存储的内容包括虚拟地址、物理地址和保护位，可分别对应于Cache的Tag、Data和状态位。包含TLB的地址转换过程如图[3.3](sec-privileged-ISA.html#fig:tlb-convert)所示。

![包含TLB的地址转换过程](images/chapter3/tlb_convert.png){width="50%"}
...
### [3.3.2]{.header-section-number} TLB的结构和使用

#### [3.3.2.1]{.header-section-number} 地址空间和地址翻译模式
...
#### [3.3.2.2]{.header-section-number} TLB结构
...
在虚实地址转换过程中，STLB和MTLB同时查找。相应地，软件需保证不会出现MTLB和STLB同时命中的情况，否则处理器行为将不可知。MTLB采用全相联查找表的组织形式，STLB采用多路组相联的组织形式。对于STLB，如果其有2^INDEX^组，且配置的页大小为2^PS^字节，那么硬件查询STLB的过程中，是将虚地址的[\\\[PS+INDEX:PS\\\]]{.math .display}位作为索引值来访问各路信息的。接下来介绍LoongArch64指令系统中TLB单个表项的结构，如图[3.4](sec-privileged-ISA.html#fig:tlb-entry)所示。

![LoongArch64指令系统中TLB表项结构](images/chapter3/tlb_entry.png){width="100%"}
...
#### [3.3.2.3]{.header-section-number} TLB虚实地址翻译过程
...
上述第三类寄存器的工作及使用方式将在后面[3.3.3](sec-privileged-ISA.html#sec-tlb-ex)节中予以介绍。

#### [3.3.2.5]{.header-section-number} TLB访问和控制指令
...
### [3.3.3]{.header-section-number} TLB地址翻译相关异常的处理
...
#### [3.3.3.1]{.header-section-number} 多级页表结构

Linux操作系统通常采用多级页表结构。对于64位的LoongArch处理器，如果其有效虚地址位宽为48位，那么当Linux操作系统采用16KB页大小时，其页表为三级结构，如图[3.6](sec-privileged-ISA.html#fig:page-table)所示。33位的虚双页号（VPPN）分为三个部分：最高11位作为一级页表（页目录表PGD）索引，一级页表中每一项保存一个二级页表（页目录表PMD）的起始地址；中间11位作为二级页表索引，二级页表中每一项保存一个三级页表（末级页表PTE）的起始地址；最低11位作为三级页表索引。每个三级页表包含2048个页表项，每个页表项管理一个物理页，大小为8字节，包括RPLV、NX、NR、PPN、W、P、G、MAT、PLV、D、V的信息。"P"和"W"两个域分别代表物理页是否存在，以及该页是否可写。这些信息虽然不填入TLB表项中，但用于页表遍历的处理过程。每个进程的PGD表基地址放在进程上下文中，内核进程进行切换时把PGD表的基地址写到CSR.PGDH的Base域中，用户进程进行切换时把PGD表的基地址写到CSR.PGDL的Base域中。

![Linux/LoongArch三级页表结构](images/chapter3/page_table.png){width="100%"}

图 3.6: Linux/LoongArch三级页表结构

#### [3.3.3.2]{.header-section-number} TLB重填异常处理
...
整个TLB重填异常处理过程中，遍历多级页表是一个较为复杂的操作，需要数十条普通访存、运算指令才能完成，而且如果遍历的页表级数增加，则需要更多的指令。LoongArch指令系统中定义了LDDIR和LDPTE指令以及与之配套的CSR.PWCL和CSR.PWCH来加速TLB重填异常处理中的页表遍历。LDDIR和LDPTE指令的功能简述如表[3.3](sec-privileged-ISA.html#tab:lddir-ldpte)所示。
...
::: tabwid
  [指令]{.cl-2506439c}                  [描述]{.cl-2506439c}
  ------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [LDDIR rd, rj, level]{.cl-250643a6}   [将rj寄存器中的值作为当前页目录表的基地址，同时根据CSR.TLBRBADV中VAddr域存放的TLB缺失地址以及PWCL、PWCH寄存器中定义的页目录表level索引的起始位置和位宽信息计算出当前目录页表的偏移量，两者相加作为访存地址，从内存中读取待访问页目录表/页表的基址，写入rd寄存器中。]{.cl-250643a6}
  [LDPTE rj, seq]{.cl-250643a6}         [将rj寄存器中的值作为末级页表的基地址，同时根据CSR.TLBRBADV中VAddr域存放的TLB缺失地址以及PWCL、PWCH寄存器中定义的末级页表索引的起始位置和位宽信息计算出末级页表的偏移量，两者相加作为访存地址，从内存中读取偶数号(seq=0)或奇数号(seq=1)页表项的内容，将其写入到TLBRELO0或TLBRELO1寄存器中。]{.cl-250643a6}

  : [表 3.3: ]{#tab:lddir-ldpte}LoongArch软件页表遍历指令 {.cl-2509e4d4}
...
#### [3.3.3.3]{.header-section-number} 其它TLB地址翻译相关异常处理
...
## [3.4]{.header-section-number} 本章小结
...
![](images/chapter3/memcpy_program.png){width="50%" style="display: block; margin: auto;"} 5. 请用C语言伪代码形式描述一台64位LoongArch机器上的TLB进行访存虚实地址转换的过程（包含TLB地址翻译相关异常的判定过程）。（提示：①可以将TLB的每一项定义为一个结构体，将整个TLB视作一个结构体数组；②无须直接体现过程中电路的并发执行特性，只需要确保最终逻辑状态一致即可。）
...
3.  ::: {#fn3}
    特指直接运行在CPU上的应用，把虚拟机及其上运行的应用作为整体看待。[↩︎](sec-privileged-ISA.html#fnref3){.footnote-back}

4.  ::: {#fn4}
    这里CSR_CRMD是一个宏定义，表示一个立即数，其值为CRMD控制状态寄存器的编号0x0。使用CSR_CRMD这样的宏定义是为了便于代码理解。[↩︎](sec-privileged-ISA.html#fnref4){.footnote-back}

5.  ::: {#fn5}
    这里"CPU核"可以更为严格地理解为CPU核的指令流水线，即旨在强调这些事件并非直接由指令引发。以定时中断为例，它由一个物理上独立于CPU指令流水线而存在的定时器触发，但是这个定时器既可以放置在CPU核内部也可以放置在CPU核外部。[↩︎](sec-privileged-ISA.html#fnref5){.footnote-back}

6.  ::: {#fn6}
    这只是通常的处理流程，但并非始终如此，存在某些异常处理场景，其结束后返回执行的并非最初被该异常打断的指令。例如，当执行SYSCALL指令而陷入系统调用异常处理时，肯定不能在处理结束后返回触发异常的SYSCALL指令，否则将陷入死循环。再譬如，当发生中断并陷入操作系统核心进行处理时，处理结束后，操作系统可能将其他进程或线程调度到该CPU上执行，显然此时返回执行的并不是最初被中断打断的那条指令。[↩︎](sec-privileged-ISA.html#fnref6){.footnote-back}

7.  ::: {#fn7}
    其实TLB重填异常发生时，这一信息将被记录在CSR.TLBRBERA中;机器错误异常发生时，这一信息将被记录在CSR.MERRERA中。更多细节请见下文中的说明。[↩︎](sec-privileged-ISA.html#fnref7){.footnote-back}

8.  ::: {#fn8}
    尽管将ECFG控制状态寄存器中的VS域置0后，所有的异常处理程序入口地址将变为同一个，此时中断不再是向量中断形式，但这种模式并不是LoongArch指令系统推荐的方式。[↩︎](sec-privileged-ISA.html#fnref8){.footnote-back}

9.  ::: {#fn9}
    PC域不包含指令地址的最低两位，因为能触发TLB重填异常的指令的PC最低两位一定为0，所以这两位不需要记录。[↩︎](sec-privileged-ISA.html#fnref9){.footnote-back}

10. ::: {#fn10}
    如果第一条指令即为访存指令[↩︎](sec-privileged-ISA.html#fnref10){.footnote-back}
