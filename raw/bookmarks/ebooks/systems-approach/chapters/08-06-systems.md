...
title: "8.5 Example Systems &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 8.5 Example Systems &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

8.5 Example Systems — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
[Problem: Security Attacks](problem.html)
- [8.1 Trust and Threats](trust.html)
- [8.2 Cryptographic Building Blocks](crypto.html)
- [8.3 Key Predistribution](key-distro.html)
- [8.4 Authentication Protocols](authentication.html)
- 8.5 Example Systems
...
- [Perspective: Is Security Getting Worse or Better?](trend.html)
...
- [Print Copies](../print.html)
      ...
      - 8.5 Example Systems
      -
            [ View page source](../_sources/security/systems.rst.txt)
...
[![../_images/f08-13-9780123850591.png](./images/f08-13-9780123850591.png)
](../_images/f08-13-9780123850591.png)
Figure 206. PGP’s steps to prepare a message for emailing from Alice to Bob.
...
illustrated in Figure 206. First, the
...
[![../_images/f08-14-9780123850591.png](./images/f08-14-9780123850591.png)
](../_images/f08-14-9780123850591.png)
Figure 207. Using SSH port forwarding to secure other TCP-based applications.
...
the SSH-CONN protocol. The idea is illustrated in Figure
207, where we see a client on host A indirectly
...
Figure 208.
[![../_images/f08-15-9780123850591.png](./images/f08-15-9780123850591.png)
](../_images/f08-15-9780123850591.png)
Figure 208. Secure transport layer inserted between application and TCP layers.
...
Figure 209 shows the handshake protocol at a
...
master secret later.
[![../_images/f08-16-9780123850591.png](./images/f08-16-9780123850591.png)
](../_images/f08-16-9780123850591.png)
Figure 209. Handshake protocol to establish TLS session.
...
- Fragmented or coalesced into blocks of a convenient size for the
following steps
- Optionally compressed
- Integrity-protected using an HMAC
- Encrypted using a secret-key cipher
- Passed to the transport layer (normally TCP) for transmission
...
required to get the design right. [[Next]](../applications/infrastructure.html#key-naming)
## 8.5.4 IP Security (IPsec)
...
in Figure 210. The `SPI` field lets the receiving host
...
[![../_images/f08-17-9780123850591.png](./images/f08-17-9780123850591.png)
](../_images/f08-17-9780123850591.png)
Figure 210. IPSec’s ESP format.
...
packet, as in Figure 211. The source
...
destination.
[![../_images/f08-18-9780123850591.png](./images/f08-18-9780123850591.png)
](../_images/f08-18-9780123850591.png)
Figure 211. An IP packet with a nested IP packet encapsulated using ESP in tunnel
...
Authentication Server (AS) as in Figure 212. The AS and AP must be connected by a secure
...
authentication.
[![../_images/f08-19-9780123850591.png](./images/f08-19-9780123850591.png)
](../_images/f08-19-9780123850591.png)
Figure 212. Use of an Authentication Server in 802.11i.
...
as illustrated in Figure 213. It is usually
...
TCP port numbers.
[![../_images/f08-20-9780123850591.png](./images/f08-20-9780123850591.png)
](../_images/f08-20-9780123850591.png)
Figure 213. A firewall filters packets flowing between a site and the rest of the
Internet.
