---
source: https://book.systemsapproach.org/internetworking/ethernet.html
title: "3.2 Switched Ethernet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 3.2 Switched Ethernet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

3.2 Switched Ethernet — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 3.2 Switched Ethernet
      -
            [ View page source](../_sources/internetworking/ethernet.rst.txt)
        [ Previous](switching.html)
        [Next ](basic-ip.html)
# 3.2 Switched Ethernet
...
Figure 64. Whenever a frame from host A that is
...
[![../_images/f03-09-9780123850591.png](./images/f03-09-9780123850591.png)
](../_images/f03-09-9780123850591.png)
Figure 64. Illustration of a learning bridge.
One option would be to have a human download a table into the bridge
similar to the one given in Table 9. Then,
...
port 1.
Table 9. Forwarding Table Maintained by a Bridge.
Host
Port
A
1
...
bridge can build a table just like Table 9.
...
Figure 65, where switches S1, S4, and S6 form a loop.
[![../_images/Slide5.png](./images/Slide5.png)
](../_images/Slide5.png)
...
edges. For example, Figure 66 shows a cyclic
graph on the left and one of possibly many spanning trees on the
right.
[![../_images/f03-11-9780123850591.png](./images/f03-11-9780123850591.png)
](../_images/f03-11-9780123850591.png)
Figure 66. Example of (a) a cyclic graph; (b) a corresponding spanning
tree.
...
[![../_images/Slide6.png](./images/Slide6.png)
](../_images/Slide6.png)
Figure 67. Spanning tree with some ports not selected.
Figure 67 shows the spanning tree that
corresponds to the network shown in Figure 65. In this example, S1 is the root, since it has the
...
Figure 65 and to compute the spanning tree given
in the Figure 67 according to the rules given
...
Figure 67 if the power had just been restored to a campus,
...
- S3 adds one to the distance advertised by S2 (0) and thus sends
(S2, 1, S3) toward S5.
...
- S3 accepts S1 as root, and it notes that both S2 and S5 are closer to
the root than it is, but S2 has the smaller id, so it remains on S3’s
path to the root.
This leaves S3 with active ports as shown in Figure 67.
...
Figure 67.  If host C does not belong to group
...
[![../_images/Slide7.png](./images/Slide7.png)
](../_images/Slide7.png)
Figure 68. Two virtual LANs share a common backbone.
We can see how VLANs work with an example. Figure 68 shows four hosts and two switches. In the absence of
...
[![../_images/Slide42.png](./images/Slide42.png)
](../_images/Slide42.png)
Figure 69. 802.1Q VLAN tag embedded within an Ethernet (802.1)
header.
