...
title: "6.2 Queuing Disciplines &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 6.2 Queuing Disciplines &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

6.2 Queuing Disciplines — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 6.2 Queuing Disciplines
      -
            [ View page source](../_sources/congestion/queuing.rst.txt)
...
first packet to be transmitted. This is illustrated in Figure
156(a), which shows a FIFO with “slots” to hold up to eight
...
the router discards that packet, as shown in Figure 156(b). This is done without regard to which flow the packet
...
dropped.
[![../_images/f06-05-9780123850591.png](./images/f06-05-9780123850591.png)
](../_images/f06-05-9780123850591.png)
Figure 156. FIFO queuing (a), and tail drop at a FIFO queue (b).
...
Figure 157.  When a flow sends packets too quickly,
...
[![../_images/f06-06-9780123850591.png](./images/f06-06-9780123850591.png)
](../_images/f06-06-9780123850591.png)
Figure 157. Round-robin service of four flows at a router.
...
router starts to transmit packet *i*, and let \(F_i\)
denote the time when the router finishes transmitting packet *i*. If
\(P_i\) is expressed in terms of how many clock ticks it takes to transmit
...
using the above formula. We then treat all the \(F_i\) as timestamps,
...
[![../_images/f06-07-9780123850591.png](./images/f06-07-9780123850591.png)
](../_images/f06-07-9780123850591.png)
Figure 158. Example of fair queuing in action: (a) Packets with
...
the example given in Figure 158. Part (a)
...
are *n* flows sending data, I cannot use more than 1/nth
...
getting \(1/n^{th}\) of the bandwidth when there are *n*
...
mechanism in a later section. [[Next]](avoidance.html#key-red)
        [ Previous](issues.html)
        [Next ](tcpcc.html)
    © Copyright 2024.
