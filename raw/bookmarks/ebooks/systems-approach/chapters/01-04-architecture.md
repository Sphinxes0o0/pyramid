---
source: https://book.systemsapproach.org/foundation/architecture.html
title: "1.3 Architecture &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 1.3 Architecture &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

1.3 Architecture — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 1.3 Architecture
      -
            [ View page source](../_sources/foundation/architecture.rst.txt)
        [ Previous](requirements.html)
        [Next ](software.html)
# 1.3 Architecture
...
[![../_images/f01-08-9780123850591.png](./images/f01-08-9780123850591.png)
](../_images/f01-08-9780123850591.png)
Figure 8. Example of a layered network system.
...
Figure 8. The layer immediately above the
...
[![../_images/f01-09-9780123850591.png](./images/f01-09-9780123850591.png)
](../_images/f01-09-9780123850591.png)
Figure 9. Layered system with alternative abstractions available
at a given layer.
...
service (the peer interface). This situation is illustrated in Figure
10.
[![../_images/f01-10-9780123850591.png](./images/f01-10-9780123850591.png)
](../_images/f01-10-9780123850591.png)
Figure 10. Service interfaces and peer interfaces.
...
and the edges represent a *depends on* relation. For example, Figure
11 illustrates a protocol graph for the hypothetical
...
service.
[![../_images/f01-11-9780123850591.png](./images/f01-11-9780123850591.png)
](../_images/f01-11-9780123850591.png)
Figure 11. Example of a protocol graph.
...
## 1.3.2 Encapsulation
Consider what happens in Figure 11 when one
...
[![../_images/f01-12-9780123850591.png](./images/f01-12-9780123850591.png)
](../_images/f01-12-9780123850591.png)
Figure 12. High-level messages are encapsulated inside of low-level messages.
...
in Figure 12. Note that in this example,
...
Figure 11, for example, we can think of RRP as
...
Interconnection* (OSI) architecture and illustrated in Figure
13, defines a partitioning of network functionality into
...
Figure 13 is not a protocol graph, *per se*, but
...
[![../_images/f01-13-9780123850591.png](./images/f01-13-9780123850591.png)
](../_images/f01-13-9780123850591.png)
Figure 13. The OSI 7-layer model.
...
Figure 14. An alternative representation is
given in Figure 15. The Internet
...
[![../_images/f01-14-9780123850591.png](./images/f01-14-9780123850591.png)
](../_images/f01-14-9780123850591.png)
Figure 14. Internet protocol graph.
[![../_images/f01-15-9780123850591.png](./images/f01-15-9780123850591.png)
](../_images/f01-15-9780123850591.png)
Figure 15. Alternative view of the Internet architecture. The “subnetwork” layer
...
level is a wide variety of network protocols, denoted NET1,
NET2, and so on. In practice, these protocols are implemented
...
highlighting. First, as best illustrated by Figure 15, the Internet architecture does not imply strict
...
Second, if you look closely at the protocol graph in Figure
14, you will notice an hourglass shape—wide at the top,
...
demands and changing technologies. [[Next]](../direct/reliable.html#key-pipe-full)
        [ Previous](requirements.html)
        [Next ](software.html)
    © Copyright 2024.
