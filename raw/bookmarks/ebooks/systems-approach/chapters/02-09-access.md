---
source: https://book.systemsapproach.org/direct/access.html
title: "2.8 Access Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.8 Access Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

2.8 Access Networks — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 2.8 Access Networks
      -
            [ View page source](../_sources/direct/access.rst.txt)
        [ Previous](wireless.html)
        [Next ](trend.html)
# 2.8 Access Networks
...
Cellular access networks are anchored in these facilities.[1]
[1]
...
Figure 52 shows an example PON, simplified to
depict just one
...
Figure 52 also includes two other details about
how the PON is
...
[![../_images/Slide12.png](./images/Slide12.png)
](../_images/Slide12.png)
Figure 52. An example PON that connects OLTs in the Central Office
...
Figure 53 depicts one possible configuration of
...
Figure 53, it is sometimes the case that the ISP’s
PON network is used to connect the remote BBUs back to the Central
Office.
[![../_images/Slide2.png](./images/Slide2.png)
](../_images/Slide2.png)
Figure 53. A Radio Access Network (RAN) connecting a set of cellular devices
...
as a two-dimensional resource, as shown in Figure 54.  The minimal schedulable unit, called a *Resource
...
symbol.
[![../_images/Slide4.png](./images/Slide4.png)
](../_images/Slide4.png)
Figure 54. The available radio spectrum abstractly represented by
...
Figure 54 shows two back-to-back PRBs, where UEs are
...
The 1ms *Transmission Time Interval (TTI)* shown in Figure
54 corresponds to the time frame in which the BBU receives
...
radio spectrum.[2] The bands with carrier frequencies below 1GHz are
...
Figure 54. The corresponding scheduling
intervals are 0.5ms and 0.25ms, respectively. (We used 0.5ms in the
example shown in Figure 54.)
