---
source: https://book.systemsapproach.org/applications/overlays.html
title: "9.4 Overlay Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 9.4 Overlay Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

9.4 Overlay Networks — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
[Problem: Applications Need Their Own Protocols](problem.html)
- [9.1 Traditional Applications](traditional.html)
- [9.2 Multimedia Applications](multimedia.html)
- [9.3 Infrastructure Applications](infrastructure.html)
...
Mechanisms
- Policies
- [Perspective: The Cloud is the New Internet](trend.html)
...
- [Print Copies](../print.html)
      ...
      - 9.4 Overlay Networks
      -
            [ View page source](../_sources/applications/overlays.rst.txt)
        [ Previous](infrastructure.html)
        [Next ](trend.html)
# 9.4 Overlay Networks
...
[![../_images/f09-19-9780123850591.png](./images/f09-19-9780123850591.png)
](../_images/f09-19-9780123850591.png)
Figure 234. Overlay network layered on top of a physical network.
...
telephone network. Figure 234 depicts an
...
[![../_images/f09-20-9780123850591.png](./images/f09-20-9780123850591.png)
](../_images/f09-20-9780123850591.png)
Figure 235. Overlay nodes tunnel through physical nodes.
...
attached an inner header. Figure 235
...
glory.
[![../_images/f09-21-9780123850591.png](./images/f09-21-9780123850591.png)
](../_images/f09-21-9780123850591.png)
Figure 236. Alternative multicast trees mapped onto a physical topology.
...
to send a multicast message to the other three hosts, Figure
236 shows how naive unicast transmission would
...
traverse R1-R2. Figure 236 depicts the IP
...
in Figure 236. End system multicast defines an
architecture for constructing this tree.
[![../_images/f09-22-9780123850591.png](./images/f09-22-9780123850591.png)
](../_images/f09-22-9780123850591.png)
Figure 237. Multicast tree embedded in an overlay network.
...
idea is illustrated in Figure 237,
...
the Internet. Figure 238 illustrates what we
...
the destination.
[![../_images/f09-23-9780123850591.png](./images/f09-23-9780123850591.png)
](../_images/f09-23-9780123850591.png)
Figure 238. The triangle inequality does not necessarily hold in networks.
...
networks. [[Next]](../foundation/requirements.html#key-nested)
## 9.4.2 Peer-to-Peer Networks
...
one shown in Figure 239. That is, each node
...
[![../_images/f09-24-9780123850591.png](./images/f09-24-9780123850591.png)
](../_images/f09-24-9780123850591.png)
Figure 239. Example topology of a gnutella peer-to-peer network.
...
address.
[![../_images/f09-25-9780123850591.png](./images/f09-25-9780123850591.png)
](../_images/f09-25-9780123850591.png)
Figure 240. Both nodes and objects map (hash) onto the ID space, where objects are
...
*x* uniformly across a large ID space. Figure 240
...
leaves.
[![../_images/f09-26-9780123850591.png](./images/f09-26-9780123850591.png)
](../_images/f09-26-9780123850591.png)
Figure 241. Objects are located by routing through the peer-to-peer overlay network.
...
Figure 241 illustrates what happens for a simple
...
*j* in the *i+1*-th position. Figure 242 shows the first three
...
[
](../_images/f09-27-9780123850591.png)
Figure 242. Example routing table at the node with ID 65alcx
[
](../_images/f09-28-9780123850591.png)
Figure 243. Adding a node to the network.
...
Figure 243. It is through this routing process
...
from multiple peers, not just the original peer. See Figure 244.
[
](../_images/f09-29-9780123850591.png)
Figure 244. Peers in a BitTorrent swarm download from other peers that may not yet
...
[
](../_images/f09-30-9780123850591.png)
Figure 245. Components in a Content Distribution Network (CDN).
...
appropriate server, as shown in Figure 245. The primary
