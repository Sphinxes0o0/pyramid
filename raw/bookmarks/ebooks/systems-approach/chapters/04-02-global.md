---
source: https://book.systemsapproach.org/scaling/global.html
title: "4.1 Global Internet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 4.1 Global Internet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

4.1 Global Internet — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
[Problem: Scaling to Billions](problem.html)
- 4.1 Global Internet
4.1.1 Routing Areas
...
- [Print Copies](../print.html)
      ...
      - 4.1 Global Internet
      -
            [ View page source](../_sources/scaling/global.rst.txt)
        [ Previous](problem.html)
        [Next ](ipv6.html)
# 4.1 Global Internet
...
it has.
[![../_images/f04-01-9780123850591.png](./images/f04-01-9780123850591.png)
](../_images/f04-01-9780123850591.png)
Figure 97. The tree structure of the Internet in 1990.
...
organizations. Figure 97 gives a simple depiction of the
...
domain divided into areas is shown in Figure 98 .
...
[![../_images/f04-02-9780123850591.png](./images/f04-02-9780123850591.png)
](../_images/f04-02-9780123850591.png)
Figure 98. A domain divided into areas.
...
any single Internet Service Provider (ISP). Figure 99 shows a simple network with two autonomous systems.
[![../_images/f04-03-9780123850591.png](./images/f04-03-9780123850591.png)
](../_images/f04-03-9780123850591.png)
Figure 99. A network with two autonomous systems.
...
illustrated in Figure 97, and did not allow for the
...
shown in Figure 100. (It turns out there is still some
...
structure.)
[![../_images/f04-04-9780123850591.png](./images/f04-04-9780123850591.png)
](../_images/f04-04-9780123850591.png)
Figure 100. A simple multi-provider Internet.
Unlike the simple tree-structured Internet shown in Figure
97, or even the fairly simple picture in Figure
100, today’s Internet consists of a richly interconnected
...
Figure 100 is an example of a stub AS.
...
corporation at the top of Figure 100.
...
backbone providers in Figure 100.
...
[![../_images/f04-05-9780123850591.png](./images/f04-05-9780123850591.png)
](../_images/f04-05-9780123850591.png)
Figure 101. Example of a network running BGP.
To see how this works, consider the very simple example network in
Figure 101. Assume that the providers are transit
...
[![../_images/f04-06-9780123850591.png](./images/f04-06-9780123850591.png)
](../_images/f04-06-9780123850591.png)
Figure 102. Example of loop among autonomous systems.
An important job of BGP is to prevent the establishment of looping
paths. For example, consider the network illustrated in
Figure 102. It differs from Figure 101 only in the addition of an extra link between AS 2 and AS
...
message, the format of which is shown in Figure 103. (Note that the fields in this figure are multiples of
16 bits, unlike other packet formats in this chapter.)
[![../_images/f04-07-9780123850591.png](./images/f04-07-9780123850591.png)
](../_images/f04-07-9780123850591.png)
Figure 103. BGP-4 update packet format.
...
Figure 104. The three common relationships and
the policies that go with them are as follows:
[![../_images/f04-08-9780123850591.png](./images/f04-08-9780123850591.png)
](../_images/f04-08-9780123850591.png)
Figure 104. Common AS relationships.
...
on the order of the number of networks in a single AS. [[Next]](../e2e/tcp.html#key-e2e)
### Integrating Interdomain and Intradomain Routing
...
[
](../_images/f04-09-9780123850591.png)
Figure 105. Example of interdomain and intradomain routing. All
...
representing a single AS, in Figure 105. The three
...
Figure 106, which shows the information that
...
[
](../_images/f04-10-9780123850591.png)
Figure 106. BGP routing table, IGP routing table, and combined
table at router B.
        [ Previous](problem.html)
        [Next ](ipv6.html)
    © Copyright 2024.
