---
source: https://book.systemsapproach.org/data/problem.html
title: "Problem: What Do We Do with the Data? &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Problem: What Do We Do with the Data? &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Problem: What Do We Do with the Data? — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Problem: What Do We Do with the Data?
      -
            [ View page source](../_sources/data/problem.rst.txt)
        [ Previous](../data.html)
        [Next ](presentation.html)
# Problem: What Do We Do with the Data?
