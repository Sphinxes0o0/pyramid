---
source: https://book.systemsapproach.org/direct/ethernet.html
title: "2.6 Multi-Access Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.6 Multi-Access Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

2.6 Multi-Access Networks — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 2.6 Multi-Access Networks
      -
            [ View page source](../_sources/direct/ethernet.rst.txt)
        [ Previous](reliable.html)
        [Next ](wireless.html)
# 2.6 Multi-Access Networks
...
plugged into the host. This configuration is shown in Figure
39.
[![../_images/f02-22-9780123850591.png](./images/f02-22-9780123850591.png)
](../_images/f02-22-9780123850591.png)
...
Figure 40; that is, a segment running down the
spine of a building with a segment on each floor.
[![../_images/f02-23-9780123850591.png](./images/f02-23-9780123850591.png)
](../_images/f02-23-9780123850591.png)
Figure 40. Ethernet repeater, interconnecting segments to form a larger
collision domain.
...
41. The 64-bit preamble allows the receiver to
...
removes them.
[![../_images/f02-25-9780123850591.png](./images/f02-25-9780123850591.png)
](../_images/f02-25-9780123850591.png)
...
probability \(0 \le p \le 1\) after a line becomes idle and defers
...
during this time.
[![../_images/f02-26-9780123850591.png](./images/f02-26-9780123850591.png)
](../_images/f02-26-9780123850591.png)
Figure 42. Worst-case scenario: (a) A sends a frame at time t;
...
Figure 42 illustrates the worst-case scenario,
where hosts A
...
for k = 0..23 - 1, again selected at random. In general,
the algorithm randomly selects a *k* between 0 and 2n - 1
