...
title: "7.1 Presentation Formatting &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 7.1 Presentation Formatting &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

7.1 Presentation Formatting — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Perspective: Big Data and Analytics](trend.html)
...
- [Print Copies](../print.html)
      ...
      - 7.1 Presentation Formatting
      -
            [ View page source](../_sources/data/presentation.rst.txt)
...
illustrated in Figure 179, the sending program
...
message.
[![../_images/f07-01-9780123850591.png](./images/f07-01-9780123850591.png)
](../_images/f07-01-9780123850591.png)
...
of the integer 34,677,374 are given in Figure 180.
[![../_images/f07-02-9780123850591.png](./images/f07-02-9780123850591.png)
](../_images/f07-02-9780123850591.png)
...
network. Figure 181 illustrates this task.
[![../_images/f07-03-9780123850591.png](./images/f07-03-9780123850591.png)
](../_images/f07-03-9780123850591.png)
...
data contained in the message was generated. Figure 182 depicts how a simple 32-bit integer might be encoded in a
tagged message.
[![../_images/f07-04-9780123850591.png](./images/f07-04-9780123850591.png)
](../_images/f07-04-9780123850591.png)
...
procedure’s interface. This situation is illustrated in Figure
183. Since the stub is compiled, it is usually very efficient.
...
[![../_images/f07-05-9780123850591.png](./images/f07-05-9780123850591.png)
](../_images/f07-05-9780123850591.png)
Figure 183. Stub compiler takes interface description as input and outputs client
and server stubs.
## 7.1.2 Examples (XDR, ASN.1, NDR, ProtoBufs)
...
[![../_images/f07-06-9780123850591.png](./images/f07-06-9780123850591.png)
](../_images/f07-06-9780123850591.png)
...
Figure 184 schematically depicts XDR’s on-the-wire
...
nesting primitive types, as illustrated in Figure 185.
[![../_images/f07-07-9780123850591.png](./images/f07-07-9780123850591.png)
](../_images/f07-07-9780123850591.png)
Figure 185. Compound types created by means of nesting in ASN.1 BER.
[![../_images/f07-08-9780123850591.png](./images/f07-08-9780123850591.png)
](../_images/f07-08-9780123850591.png)
...
encode the integer, as illustrated in Figure 186. The
...
up the `length`. Figure 187 illustrates a simple
1-byte `length` and a multibyte `length`.
[
](../_images/f07-09-9780123850591.png)
...
[
](../_images/f07-10-9780123850591.png)
Figure 188. NDR’s architecture tag.
Figure 188 illustrates the 4-byte architecture
