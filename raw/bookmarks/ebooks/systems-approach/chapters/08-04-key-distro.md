...
title: "8.3 Key Predistribution &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 8.3 Key Predistribution &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

8.3 Key Predistribution — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 8.3 Key Predistribution
      -
            [ View page source](../_sources/security/key-distro.rst.txt)
        [ Previous](crypto.html)
...
tree-structured hierarchy, as shown in Figure 199. If everyone has the public key of the root CA, then
...
[![../_images/f08-06-9780123850591.png](./images/f08-06-9780123850591.png)
](../_images/f08-06-9780123850591.png)
Figure 199. Tree-structured certification authority hierarchy.
...
\(\bmod p\) (short for modulo *p*) are \(0\) through *p-1*,
since \(x \bmod p\) is the remainder after *x* is divided by *p*,
...
there must be some value *k* such that \(n = g^k \bmod p\). For
...
integers \(\{1,\dots{}, p-1\}\). Alice and Bob derive their
...
Alice and Bob now have \(g^{ab} \bmod p\) (which is equal to
...
by substituting Alice’s public value for \((2^a \bmod 5)\).
...
she generates random private values \(c\) and \(d\) to use
...
values, as in Figure 200. The result is
that Alice and Bob each end up unknowingly sharing a key with Mallory
instead of each other.
[![../_images/f08-12-9780123850591.png](./images/f08-12-9780123850591.png)
](../_images/f08-12-9780123850591.png)
Figure 200. A man-in-the-middle attack.
