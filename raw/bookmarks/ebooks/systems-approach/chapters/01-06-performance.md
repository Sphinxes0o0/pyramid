---
source: https://book.systemsapproach.org/foundation/performance.html
title: "1.5 Performance &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 1.5 Performance &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

1.5 Performance — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 1.5 Performance
      -
            [ View page source](../_sources/foundation/performance.rst.txt)
        [ Previous](software.html)
        [Next ](trend.html)
# 1.5 Performance
...
bit on a 2-Mbps link is 0.5 μs wide, as illustrated in Figure
16. The more sophisticated the transmitting and receiving
...
of data.
[![../_images/f01-16-9780123850591.png](./images/f01-16-9780123850591.png)
](../_images/f01-16-9780123850591.png)
Figure 16. Bits transmitted at a particular bandwidth can be
...
in a copper cable, and 2.0 × 108 m/s in an optical fiber.
...
transmit the image (25 × 106 × 8-bits / 10 × 106
...
negligible.
[![../_images/f01-17-9780123850591.png](./images/f01-17-9780123850591.png)
](../_images/f01-17-9780123850591.png)
Figure 17. Perceived latency (response time) versus round-trip
time for various object sizes and link speeds.
Figure 17 gives you a sense of how latency or
...
channel between a pair of processes as a hollow pipe (see Figure
18), where the latency corresponds to the length of the pipe
...
[![../_images/f01-18-9780123850591.png](./images/f01-18-9780123850591.png)
](../_images/f01-18-9780123850591.png)
Figure 18. Network as a pipe.
...
5.5 × 106 bits (671 KB) of data. On the other hand, if
...
one-way latency or RTT is made clear by the context. Table 1 shows some examples of RTT × bandwidth products for
some typical network links.
Table 1. Example delay × bandwidth products.
Link Type
Bandwidth
One-Way Distance
RTT
...
of 12.5 MB.
Figure 19 illustrates the difference between the two
...
to a 1-Mbps network.
[![../_images/f01-19-9780123850591.png](./images/f01-19-9780123850591.png)
](../_images/f01-19-9780123850591.png)
Figure 19. Relationship between bandwidth and latency. A 1-MB
...
stream, as shown in Figure 20. Such variation
...
with time.
[![../_images/f01-20-9780123850591.png](./images/f01-20-9780123850591.png)
](../_images/f01-20-9780123850591.png)
