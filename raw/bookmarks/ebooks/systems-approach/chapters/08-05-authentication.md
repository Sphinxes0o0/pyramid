---
source: https://book.systemsapproach.org/security/authentication.html
title: "8.4 Authentication Protocols &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 8.4 Authentication Protocols &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation
...
- [Print Copies](../print.html)
      ...
      - 8.4 Authentication Protocols
      -
            [ View page source](../_sources/security/authentication.rst.txt)
        [ Previous](key-distro.html)
        [Next ](systems.html)
# 8.4 Authentication Protocols
...
(if Bob has a public key, as in Figure 201). The encrypted timestamp is like an
...
[![../_images/f08-07-9780123850591.png](./images/f08-07-9780123850591.png)
](../_images/f08-07-9780123850591.png)
Figure 201. A challenge-response protocol.
...
[![../_images/f08-08-9780123850591.png](./images/f08-08-9780123850591.png)
](../_images/f08-08-9780123850591.png)
Figure 202. A public-key authentication protocol that depends on synchronization.
This first protocol (Figure 202) relies on
...
The second protocol (Figure 203) is
...
[![../_images/f08-09-9780123850591.png](./images/f08-09-9780123850591.png)
](../_images/f08-09-9780123850591.png)
Figure 203. A public-key authentication protocol that does not depend on
...
KDC.
[![../_images/f08-10-9780123850591.png](./images/f08-10-9780123850591.png)
](../_images/f08-10-9780123850591.png)
Figure 204. The Needham-Schroeder authentication protocol.
The Needham-Schroeder authentication protocol is illustrated in
Figure 204. Note that the KDC doesn’t
...
itself, in effect—are split up (Figure 205). A
...
[![../_images/f08-11-9780123850591.png](./images/f08-11-9780123850591.png)
](../_images/f08-11-9780123850591.png)
Figure 205. Kerberos authentication.
