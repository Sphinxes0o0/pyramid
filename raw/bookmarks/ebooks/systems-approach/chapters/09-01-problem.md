---
source: https://book.systemsapproach.org/applications/problem.html
title: "Problem: Applications Need Their Own Protocols &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Problem: Applications Need Their Own Protocols &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Problem: Applications Need Their Own Protocols — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Problem: Applications Need Their Own Protocols
      -
            [ View page source](../_sources/applications/problem.rst.txt)
        [ Previous](../applications.html)
        [Next ](traditional.html)
# Problem: Applications Need Their Own Protocols
