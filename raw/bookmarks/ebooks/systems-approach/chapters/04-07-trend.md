---
source: https://book.systemsapproach.org/scaling/trend.html
title: "Perspective: The Cloud is Eating the Internet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Perspective: The Cloud is Eating the Internet &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Perspective: The Cloud is Eating the Internet — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Perspective: The Cloud is Eating the Internet
      -
            [ View page source](../_sources/scaling/trend.rst.txt)
        [ Previous](mobile-ip.html)
        [Next ](../e2e.html)
# Perspective: The Cloud is Eating the Internet
...
In other words, while the figures in [Section 4.1](global.html#global-internet) fairly represents the Internet’s overall shape, and BGP
...
more like Figure 124. (One important detail that
...
infrastructure.)
[![../_images/Slide15.png](./images/Slide15.png)
](../_images/Slide15.png)
Figure 124. Cloud is widely distributed throughout the Internet
...
(as [Section 4.3](multicast.html#multicast) suggests), but it is instead running
...
we return to in [Section 9.4](../applications/overlays.html#overlay-networks).
Broader Perspective
To continue reading about the cloudification of the Internet, see
[Perspective: HTTP is the New Narrow Waist](../e2e/trend.html#perspective-http-is-the-new-narrow-waist).
To learn more about the Cloud’s distributed footprint, we recommend
[How the Internet Travels Across the
Ocean](https://www.nytimes.com/interactive/2019/03/10/technology/internet-cables-oceans.html),
