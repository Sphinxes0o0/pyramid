---
source: https://book.systemsapproach.org/internetworking/impl.html
title: "3.5 Implementation &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 3.5 Implementation &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

3.5 Implementation — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 3.5 Implementation
      -
            [ View page source](../_sources/internetworking/impl.rst.txt)
        [ Previous](routing.html)
        [Next ](trend.html)
# 3.5 Implementation
...
commercial mid- to low-end network devices.[1] Implementations that
...
## 3.5.1 Software Switch
Figure 93 shows a software switch built
...
[![../_images/Slide14.png](./images/Slide14.png)
](../_images/Slide14.png)
Figure 93. A general-purpose processor used as a software
switch.
...
with an average data rate of about 1 Gbps on each port.[2]
[2]
...
the same CPU, as is the case in software switch depicted in Figure
93, but performance can be dramatically improved by
...
[![../_images/Slide22.png](./images/Slide22.png)
](../_images/Slide22.png)
Figure 94. Bare-metal switch using a Network Processing
Unit.
Figure 94 is a simplified depiction of a
...
Finally, Figure 94 includes other commodity
...
[![../_images/Slide32.png](./images/Slide32.png)
](../_images/Slide32.png)
Figure 95. Network Operating System (NOS) hosting a set of
...
Figure 95, is the Network Operating System
...
distributed approach is best. [[Next]](../scaling/global.html#key-tradeoffs)
