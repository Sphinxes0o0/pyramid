---
source: https://book.systemsapproach.org/applications/multimedia.html
title: "9.2 Multimedia Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 9.2 Multimedia Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

9.2 Multimedia Applications — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [9.4 Overlay Networks](overlays.html)
...
- [Print Copies](../print.html)
      ...
      - 9.2 Multimedia Applications
      -
            [ View page source](../_sources/applications/multimedia.rst.txt)
        [ Previous](traditional.html)
        [Next ](infrastructure.html)
# 9.2 Multimedia Applications
...
address of a person to contact regarding the session. Figure 221 shows a screen shot of a (now archaic) session
...
[![../_images/f09-07-9780123850591.png](./images/f09-07-9780123850591.png)
](../_images/f09-07-9780123850591.png)
Figure 221. A session directory tool displays information extracted from SDP
messages.
...
The session directory tool shown in Figure 221 would function
...
[![../_images/f09-08-9780123850591.png](./images/f09-08-9780123850591.png)
](../_images/f09-08-9780123850591.png)
Figure 222. Establishing communication through SIP proxies.
Consider the two users in Figure 222. The
...
organization of codes is similar to that for HTTP. In Figure 223 we can see a sequence of SIP messages and responses.
[![../_images/f09-09-9780123850591.png](./images/f09-09-9780123850591.png)
](../_images/f09-09-9780123850591.png)
Figure 223. Message flow for a basic SIP session.
...
illustrated in Figure 224. This enables a user running an
...
[![../_images/f09-10-9780123850591.png](./images/f09-10-9780123850591.png)
](../_images/f09-10-9780123850591.png)
Figure 224. Devices in an H.323 network.
...
Figure 225.  This is effective because of the
...
[![../_images/f09-11-9780123850591.png](./images/f09-11-9780123850591.png)
](../_images/f09-11-9780123850591.png)
Figure 225. Differentiated Services applied to a VoIP application. DiffServ queuing
...
suppose the upstream bandwidth in Figure 225 is only
...
As an example, consider the network in Figure 226. Suppose the wide area link from the branch office to
...
[![../_images/f09-12-9780123850591.png](./images/f09-12-9780123850591.png)
](../_images/f09-12-9780123850591.png)
Figure 226. Admission control using session control protocol.
...
application will use. In the simple topology of Figure 226 this isn’t a big issue, but in more complex networks it
...
control protocol.
[![../_images/f09-13-9780123850591.png](./images/f09-13-9780123850591.png)
](../_images/f09-13-9780123850591.png)
Figure 227. Coordination of SIP signalling and resource reservation.
...
had been made, in case admission control failed. Figure 227 illustrates this situation where SIP is used for
...
that shown in Figure 223, proceeds.
