---
source: https://book.systemsapproach.org/congestion/avoidance.html
title: "6.4 Advanced Congestion Control &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 6.4 Advanced Congestion Control &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

6.4 Advanced Congestion Control — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [6.3 TCP Congestion Control](tcpcc.html)
...
- [Print Copies](../print.html)
      ...
      - 6.4 Advanced Congestion Control
      -
            [ View page source](../_sources/congestion/avoidance.rst.txt)
        [ Previous](tcpcc.html)
        [Next ](qos.html)
# 6.4 Advanced Congestion Control
...
transmitting and *idle* when it is not.) Figure 166 shows the queue length at a router as a function of
...
[![../_images/f06-14-9780123850591.png](./images/f06-14-9780123850591.png)
](../_images/f06-14-9780123850591.png)
Figure 166. Computing average queue length at a router.
...
Figure 167, by filtering out short-term changes
...
below.
[![../_images/f06-15-9780123850591.png](./images/f06-15-9780123850591.png)
](../_images/f06-15-9780123850591.png)
Figure 167. Weighted running average queue length.
...
depicted in Figure 168. The approximate
relationship between `P` and `AvgLen` is shown in Figure
169. Note that the probability of drop increases slowly
...
[![../_images/f06-16-9780123850591.png](./images/f06-16-9780123850591.png)
](../_images/f06-16-9780123850591.png)
Figure 168. RED thresholds on a FIFO queue.
[![../_images/f06-17-9780123850591.png](./images/f06-17-9780123850591.png)
](../_images/f06-17-9780123850591.png)
Figure 169. Drop probability function for RED.
Although Figure 169 shows the probability of
...
`TempP` is the variable that is plotted on the y-axis in Figure
169, `count` keeps track of how many newly arriving
...
deployment of RED in the Internet. [[Next]](../security/systems.html#key-layering)
...
standard TCP given in Figure 170. The top graph
shown in Figure 170 traces the connection’s
...
[![../_images/f06-18-9780123850591.png](./images/f06-18-9780123850591.png)
](../_images/f06-18-9780123850591.png)
Figure 170. Congestion window versus observed throughput rate (the
...
Figure 170 is driving on ice. The speedometer
...
[![../_images/f06-19-9780123850591.png](./images/f06-19-9780123850591.png)
](../_images/f06-19-9780123850591.png)
Figure 171. Trace of TCP Vegas congestion-avoidance mechanism.
...
*α* and *β* thresholds.
Figure 171 traces the TCP Vegas
