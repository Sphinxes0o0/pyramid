---
source: https://book.systemsapproach.org/scaling/ipv6.html
title: "4.2 IP Version 6 &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 4.2 IP Version 6 &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

4.2 IP Version 6 — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 4.2 IP Version 6
      -
            [ View page source](../_sources/scaling/ipv6.rst.txt)
        [ Previous](global.html)
        [Next ](multicast.html)
# 4.2 IP Version 6
...
IPv6 can address 3.4 × 1038 nodes, again assuming 100%
...
The current assignment of prefixes is listed in Table 21.
Table 21. Address Prefix Assignments for IPv6.
Prefix
Use
00…0 (128 bits)
Unspecified
...
Figure 107. The `RegistryID` might be an
...
[![../_images/f04-11-9780123850591.png](./images/f04-11-9780123850591.png)
](../_images/f04-11-9780123850591.png)
Figure 107. An IPv6 provider-based unicast address.
...
to remove unnecessary functionality from the protocol. Figure
...
[![../_images/f04-12-9780123850591.png](./images/f04-12-9780123850591.png)
](../_images/f04-12-9780123850591.png)
Figure 108. IPv6 packet header.
...
[![../_images/f04-13-9780123850591.png](./images/f04-13-9780123850591.png)
](../_images/f04-13-9780123850591.png)
Figure 109. IPv6 fragmentation extension header.
...
Figure 109. This header provides functionality
...
- Obtain an interface ID that is unique on the link to which the host
is attached.
...
from Table 21 (`1111 1110 10`) followed by
