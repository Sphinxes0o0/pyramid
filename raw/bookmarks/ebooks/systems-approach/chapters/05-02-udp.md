---
source: https://book.systemsapproach.org/e2e/udp.html
title: "5.1 Simple Demultiplexor (UDP) &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 5.1 Simple Demultiplexor (UDP) &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation
...
- [Print Copies](../print.html)
      ...
      - 5.1 Simple Demultiplexor (UDP)
      -
            [ View page source](../_sources/e2e/udp.rst.txt)
...
message. For example, the UDP header is given in Figure 125.  Notice that the UDP port field is only 16 bits
...
[![../_images/f05-01-9780123850591.png](./images/f05-01-9780123850591.png)
](../_images/f05-01-9780123850591.png)
...
message queue, as illustrated in Figure 126. When a message arrives, the protocol (e.g., UDP)
...
[![../_images/f05-02-9780123850591.png](./images/f05-02-9780123850591.png)
](../_images/f05-02-9780123850591.png)
