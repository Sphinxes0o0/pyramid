---
source: https://book.systemsapproach.org/e2e/rtp.html
title: "5.4 Transport for Real-Time (RTP) &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 5.4 Transport for Real-Time (RTP) &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

5.4 Transport for Real-Time (RTP) — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 5.4 Transport for Real-Time (RTP)
      -
            [ View page source](../_sources/e2e/rtp.rst.txt)
        [ Previous](rpc.html)
        [Next ](trend.html)
# 5.4 Transport for Real-Time (RTP)
...
far in this chapter.
[![../_images/Slide41.png](./images/Slide41.png)
](../_images/Slide41.png)
Figure 147. User interface of a videoconferencing tool.
...
*streaming* applications. Figure 147 shows the
...
over UDP. That leads to the protocol stack shown in Figure 148. Note that we are therefore running a transport
...
[![../_images/f05-22-9780123850591.png](./images/f05-22-9780123850591.png)
](../_images/f05-22-9780123850591.png)
Figure 148. Protocol stack for multimedia applications using RTP.
## 5.4.1 Requirements
...
address. As illustrated in Figure 147, audio and
...
application. [[Next]](../congestion/issues.html#key-congestion)
### Header Format
Figure 149 shows the header format used by
...
[![../_images/f05-23-9780123850591.png](./images/f05-23-9780123850591.png)
](../_images/f05-23-9780123850591.png)
Figure 149. RTP header format.
...
bytes should be ignored.  This is illustrated in Figure 150. Note that this approach to padding removes any need
...
[![../_images/f05-24-9780123850591.png](./images/f05-24-9780123850591.png)
](../_images/f05-24-9780123850591.png)
Figure 150. Padding of an RTP packet.
...
**TimeBetweenPackets / TimePerSample**
**= (10 × 10-3) / (125 × 10-6) = 80**
...
- A way to correlate and synchronize different media streams that have
come from the same sender
- A way to convey the identity of a sender for display on a user
interface.
