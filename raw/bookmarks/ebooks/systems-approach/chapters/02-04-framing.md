---
source: https://book.systemsapproach.org/direct/framing.html
title: "2.3 Framing &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.3 Framing &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

2.3 Framing — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 2.3 Framing
      -
            [ View page source](../_sources/direct/framing.rst.txt)
        [ Previous](encoding.html)
        [Next ](error.html)
# 2.3 Framing
...
scenario in Figure 26. Recall from Chapter 1
...
[![../_images/f02-06-9780123850591.png](./images/f02-06-9780123850591.png)
](../_images/f02-06-9780123850591.png)
Figure 26. Bits flow between adaptors, frames between hosts.
...
given in Figure 27.
[![../_images/f02-08-9780123850591.png](./images/f02-08-9780123850591.png)
](../_images/f02-08-9780123850591.png)
Figure 27. PPP frame format.
...
its frame format is given in Figure 28.
...
[![../_images/f02-10-9780123850591.png](./images/f02-10-9780123850591.png)
](../_images/f02-10-9780123850591.png)
Figure 28. HDLC frame format.
...
runs at 51.84 Mbps.  An STS-1 frame is shown in Figure 29. It is arranged as 9 rows of 90 bytes each, and the
...
[![../_images/f02-11-9780123850591.png](./images/f02-11-9780123850591.png)
](../_images/f02-11-9780123850591.png)
Figure 29. A SONET STS-1 frame.
...
(STS-768).[1] Note that all of these rates are integer multiples of STS-1.
...
51 Mbps, rather than all bunched up during one particular \(1/N^{th}\)
of the 125-μs interval.
[![../_images/f02-12-9780123850591.png](./images/f02-12-9780123850591.png)
](../_images/f02-12-9780123850591.png)
Figure 30. Three STS-1 frames multiplexed onto one STS-3c
frame.
...
for this purpose. Figure 30 schematically depicts
...
[![../_images/f02-13-9780123850591.png](./images/f02-13-9780123850591.png)
](../_images/f02-13-9780123850591.png)
Figure 31. SONET frames out of phase.
...
boundaries. This situation is illustrated in Figure 31. Here we see both the STS-1 payload floating across two
