---
source: https://book.systemsapproach.org/foundation/requirements.html
title: "1.2 Requirements &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 1.2 Requirements &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

1.2 Requirements — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 1.2 Requirements
      -
            [ View page source](../_sources/foundation/requirements.rst.txt)
        [ Previous](applications.html)
...
the purposes of this discussion.) As illustrated in Figure 2, physical links are sometimes limited to a pair of nodes
...
rest of the network.
[![../_images/f01-02-9780123850591.png](./images/f01-02-9780123850591.png)
](../_images/f01-02-9780123850591.png)
Figure 2. Direct links: (a) point-to-point; (b) multiple-access.
...
[![../_images/f01-03-9780123850591.png](./images/f01-03-9780123850591.png)
](../_images/f01-03-9780123850591.png)
...
The cloud in Figure 3 distinguishes between the
...
chapter.
[![../_images/f01-04-9780123850591.png](./images/f01-04-9780123850591.png)
](../_images/f01-04-9780123850591.png)
Figure 4. Interconnection of networks.
A second way in which a set of computers can be indirectly connected
is shown in Figure 4. In this
...
the appropriate destination node(s). [Next]
## 1.2.3 Cost-Effective Resource Sharing
...
Figure 5, where the three hosts on the left side
...
[![../_images/f01-05-9780123850591.png](./images/f01-05-9780123850591.png)
](../_images/f01-05-9780123850591.png)
Figure 5. Multiplexing multiple logical flows over a single
physical link.
...
[![../_images/f01-06-9780123850591.png](./images/f01-06-9780123850591.png)
](../_images/f01-06-9780123850591.png)
Figure 6. A switch multiplexing packets from multiple sources
...
their packets are interleaved on the link. Figure 6 depicts a switch multiplexing packets from multiple
...
of switches interconnected by links such as the one in Figure
5, the decision would be made by the switch that transmits
...
(QoS).
Also, notice in Figure 6 that since the
...
the key challenges of statistical multiplexing. [Next]
## 1.2.4 Support for Common Services
...
[![../_images/f01-07-9780123850591.png](./images/f01-07-9780123850591.png)
](../_images/f01-07-9780123850591.png)
Figure 7. Processes communicating over an abstract channel.
...
process to another. Figure 7 shows a pair of
...
rare, affecting on average only one out of every 106 to
107 bits on a typical copper-based cable and one out of every
1012 to 1014 bits on a typical optical fiber.
...
This is sometimes called the *semantic gap.*  [[Next]](architecture.html#key-hourglass)
## 1.2.5 Manageability
