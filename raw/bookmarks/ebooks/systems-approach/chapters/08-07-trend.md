---
source: https://book.systemsapproach.org/security/trend.html
title: "Perspective: Is Security Getting Worse or Better? &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Perspective: Is Security Getting Worse or Better? &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Perspective: Is Security Getting Worse or Better? — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Perspective: Is Security Getting Worse or Better?
      -
            [ View page source](../_sources/security/trend.rst.txt)
        [ Previous](systems.html)
...
years.
Consider the arrangement of VMs and the firewall in Figure 214. Suppose that we wanted to put VM A and VM B in different segments
...
[![../_images/firewall-std.png](./images/firewall-std.png)
](../_images/firewall-std.png)
...
falling](https://www.economist.com/graphic-detail/2024/05/17/unexpectedly-the-cost-of-big-cyber-attacks-is-falling),
May 2024.
...
Networking: A Systems Approach](https://sdn.systemsapproach.org/).
        [ Previous](systems.html)
        [Next ](../applications.html)
    © Copyright 2024.
