---
source: https://book.systemsapproach.org/internetworking/switching.html
title: "3.1 Switching Basics &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 3.1 Switching Basics &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

3.1 Switching Basics — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 3.1 Switching Basics
      -
            [ View page source](../_sources/internetworking/switching.rst.txt)
...
Figure 56) to the set of possible network
...
already connected.
[![../_images/f03-01-9780123850591.png](./images/f03-01-9780123850591.png)
](../_images/f03-01-9780123850591.png)
...
Figure 57, in which the hosts have addresses A,
...
of which is depicted in Table 5. This
...
the packet.
[![../_images/f03-02-9780123850591.png](./images/f03-02-9780123850591.png)
](../_images/f03-02-9780123850591.png)
Figure 57. Datagram forwarding: an example network.
...
sent. To understand how this works, consider Figure 58, where host A again wants to send packets to
...
in turn.
[![../_images/f03-03-9780123850591.png](./images/f03-03-9780123850591.png)
](../_images/f03-03-9780123850591.png)
Figure 58. An example of a virtual circuit network.
...
example network of Figure 58, there is only
...
table configured as shown in Table 6.
...
1
4
[![../_images/f03-04-9780123850591.png](./images/f03-04-9780123850591.png)
](../_images/f03-04-9780123850591.png)
Figure 59. A packet is sent into a virtual circuit network.
Once the VC tables have been set up, the data transfer phase can
proceed, as illustrated in Figure 59. For any
...
table entry. As shown in Table 6, the table
...
table (as shown in Table 7) and sends the
packet on to switch  3 after updating the VCI value in the packet
header appropriately, as shown in Figure 60. This process continues until it arrives at host B with
...
[![../_images/f03-05-9780123850591.png](./images/f03-05-9780123850591.png)
](../_images/f03-05-9780123850591.png)
Figure 60. A packet makes its way through a virtual circuit
network.
...
previously in Table 6. The main difference is
...
as well.
[![../_images/f03-06-9780123850591.png](./images/f03-06-9780123850591.png)
](../_images/f03-06-9780123850591.png)
Figure 61. ATM cell format at the UNI.
...
commonly called an ATM *cell*—in Figure 61 will illustrate
...
path is always at the front of the list. Figure 62 illustrates this idea.
[![../_images/f03-07-9780123850591.png](./images/f03-07-9780123850591.png)
](../_images/f03-07-9780123850591.png)
Figure 62. Source routing in a switched network (where the switch
...
Figure 63. In each case, the entry that
this switch needs to read is `A`, and the entry that the next switch
needs to read is `B`.
[![../_images/f03-08-9780123850591.png](./images/f03-08-9780123850591.png)
](../_images/f03-08-9780123850591.png)
Figure 63. Three ways to handle headers for source routing:
