---
source: https://book.systemsapproach.org/congestion/qos.html
title: "6.5 Quality of Service &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 6.5 Quality of Service &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

6.5 Quality of Service — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 6.5 Quality of Service
      -
            [ View page source](../_sources/congestion/qos.rst.txt)
        [ Previous](avoidance.html)
        [Next ](trend.html)
# 6.5 Quality of Service
...
[![../_images/f06-20-9780123850591.png](./images/f06-20-9780123850591.png)
](../_images/f06-20-9780123850591.png)
Figure 172. An audio application.
### Real-Time Audio Example
As a concrete example of a real-time application, consider an audio
application similar to the one illustrated in Figure 172.
...
The operation of a playback buffer is illustrated in Figure
173. The left-hand diagonal line shows packets being
...
be useful.
[![../_images/f06-21-9780123850591.png](./images/f06-21-9780123850591.png)
](../_images/f06-21-9780123850591.png)
Figure 173. A playback buffer.
...
[![../_images/f06-22-9780123850591.png](./images/f06-22-9780123850591.png)
](../_images/f06-22-9780123850591.png)
Figure 174. Example distribution of delays for an Internet
connection.
To get a better appreciation of how variable network delay can be,
Figure 174 shows the one-way delay measured
...
of applications is summarized in Figure 175.
[![../_images/f06-23-9780123850591.png](./images/f06-23-9780123850591.png)
](../_images/f06-23-9780123850591.png)
Figure 175. Taxonomy of applications.
...
[![../_images/f06-24-9780123850591.png](./images/f06-24-9780123850591.png)
](../_images/f06-24-9780123850591.png)
Figure 176. Two flows with equal average rates but different token
bucket descriptions.
Figure 176 illustrates how a token bucket can be
...
[![../_images/f06-25-9780123850591.png](./images/f06-25-9780123850591.png)
](../_images/f06-25-9780123850591.png)
Figure 177. Making reservations on a multicast tree.
...
receivers. This situation is illustrated in Figure 177. First, let’s deal with multiple receivers for a single
...
resources for all speakers,” “Reserve resources for any \(n\)
...
section.  Figure 178 shows how RIO works; as
with RED, we see drop probability on the \(y\)-axis increasing as
average queue length increases along the \(x\)-axis. But now, for
...
[![../_images/f06-26-9780123850591.png](./images/f06-26-9780123850591.png)
](../_images/f06-26-9780123850591.png)
Figure 178. RED with In and Out drop probabilities.
...
send up to \(y\) Mbps of assured traffic,”
...
\(y\) Mbps, all his packets will be marked “in,” but once he exceeds that
...
premium packets is
**Bpremium = Wpremium / (Wpremium
+ Wbest-effort) = 1/(1 + 4) = 0.2**
