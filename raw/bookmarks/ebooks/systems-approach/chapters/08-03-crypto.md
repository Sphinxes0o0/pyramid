---
source: https://book.systemsapproach.org/security/crypto.html
title: "8.2 Cryptographic Building Blocks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 8.2 Cryptographic Building Blocks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation
...
- [8.5 Example Systems](systems.html)
...
- [Print Copies](../print.html)
      ...
      - 8.2 Cryptographic Building Blocks
      -
            [ View page source](../_sources/security/crypto.rst.txt)
        [ Previous](trust.html)
        [Next ](key-distro.html)
# 8.2 Cryptographic Building Blocks
...
Figure 195. The receiver applies a secret
...
[![../_images/f08-01-9780123850591.png](./images/f08-01-9780123850591.png)
](../_images/f08-01-9780123850591.png)
Figure 195. Secret-key encryption and decryption.
...
keys have *n* bits, then there are 2n possible values for a
...
correct value of the key, having tried all 2n possible
values; the average number of guesses to discover the correct value is
halfway between those extremes, 2n-1.  This can be made
...
Figure 196. Another mode of operation is *counter
mode*, in which successive values of a counter (e.g., 1, 2, 3,
\(\ldots\)) are incorporated into the encryption of successive
blocks of plaintext.
[![../_images/f08-02-9780123850591.png](./images/f08-02-9780123850591.png)
](../_images/f08-02-9780123850591.png)
Figure 196. Cipher Block Chaining.
## 8.2.2 Secret-Key Ciphers
In a secret-key cipher, both participants in a communication share the
same key.[1] In other words, if a message is encrypted using a particular
key, the same key is required for decrypting the message. If the
cipher illustrated in Figure 195 were a
...
you would, on average, have to search half of the space of 256 possible keys to find the right one, giving 255 =
3.6 × 1016 keys.  That may sound like a lot, but such a
...
Figure 197.
[![../_images/f08-03-9780123850591.png](./images/f08-03-9780123850591.png)
](../_images/f08-03-9780123850591.png)
Figure 197. Public-key encryption.
...
later). This is illustrated in Figure 198. It
...
[![../_images/f08-04-9780123850591.png](./images/f08-04-9780123850591.png)
](../_images/f08-04-9780123850591.png)
Figure 198. Authentication using public keys.
...
and randomly distributed, then you would need to try 2127
...
would need to compute the digests of only 264 messages, on
