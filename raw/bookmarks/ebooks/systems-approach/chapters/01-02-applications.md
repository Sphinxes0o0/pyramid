---
source: https://book.systemsapproach.org/foundation/applications.html
title: "1.1 Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 1.1 Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

1.1 Applications — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 1.1 Applications
      -
            [ View page source](../_sources/foundation/applications.rst.txt)
...
that action must be displayed at the other end as quickly as possible.[1]
[1]
...
[![../_images/f01-01-9780123850591.png](./images/f01-01-9780123850591.png)
](../_images/f01-01-9780123850591.png)
Figure 1. A multimedia application including videoconferencing.
...
such system is shown in Figure 1.  Just as
