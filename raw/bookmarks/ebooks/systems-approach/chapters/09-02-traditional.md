---
source: https://book.systemsapproach.org/applications/traditional.html
title: "9.1 Traditional Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 9.1 Traditional Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

9.1 Traditional Applications — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 9.1 Traditional Applications
      -
            [ View page source](../_sources/applications/traditional.rst.txt)
        [ Previous](problem.html)
        [Next ](multimedia.html)
# 9.1 Traditional Applications
...
implemented on top of TCP [1]. In effect, each protocol reinvents a simple
...
[![../_images/f09-01-9780123850591.png](./images/f09-01-9780123850591.png)
](../_images/f09-01-9780123850591.png)
Figure 215. Sequence of mail gateways store and forward email messages.
...
of a second. Figure 215 illustrates a two-hop path from the
...
transition diagram shown in Figure 216. In this
...
formed).
[![../_images/f09-02-9780123850591.png](./images/f09-02-9780123850591.png)
](../_images/f09-02-9780123850591.png)
Figure 216. IMAP state transition diagram.
...
1960s.[2] The core idea of hypertext is that one document can link to
...
such as Safari, Chrome, Firefox, or Internet Explorer. Figure 217 shows the Safari browser in use, displaying a page of
information from Princeton University.
[![../_images/browser-screenshot.png](./images/browser-screenshot.png)
](../_images/browser-screenshot.png)
Figure 217. The Safari web browser.
...
is summarized in Table 26. As innocent as it
sounds, the `POST` command enables much mischief (including spam) on
the Internet.
Table 26. HTTP Request Operations.
Operation
Description
OPTIONS
...
first digit of the code indicating its type. Table 27
...
separate TCP connections being established and closed. Figure
218 shows the sequence of events for fetching a page
...
and termination.
[![../_images/f09-04-9780123850591.png](./images/f09-04-9780123850591.png)
](../_images/f09-04-9780123850591.png)
Figure 218. HTTP 1.0 behavior.
...
each page. Figure 219 shows the transaction
from Figure 218 using a persistent connection
in the case where the connection is already open (presumably due to
some prior access of the same server).
[![../_images/f09-05-9780123850591.png](./images/f09-05-9780123850591.png)
](../_images/f09-05-9780123850591.png)
Figure 219. HTTP 1.1 behavior with persistent connections.
...
[Chapter 5](../e2e.html#chapter-5-end-to-end-protocols), there is no
...
[Section 5.2](../e2e/tcp.html#reliable-byte-stream-tcp).
...
pages.[3] Note that, in the second case, the users within the site most
...
Services Description Language* (WSDL) and *SOAP*.[4] Both of these
...
illustrated in Figure 220.
[![../_images/f09-06-9780123850591.png](./images/f09-06-9780123850591.png)
](../_images/f09-06-9780123850591.png)
Figure 220. SOAP message structure.
...
available HTTP methods, such as `GET` and `POST` (see Table
26). So how can these simple methods provide an interface to a
