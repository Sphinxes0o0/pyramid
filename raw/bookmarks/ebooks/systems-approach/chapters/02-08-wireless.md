---
source: https://book.systemsapproach.org/direct/wireless.html
title: "2.7 Wireless Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.7 Wireless Networks &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

2.7 Wireless Networks — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 2.7 Wireless Networks
      -
            [ View page source](../_sources/direct/wireless.rst.txt)
...
services. Table 4 gives an overview of
these technologies and how they compare to each other.
Table 4. Overview of Leading Wireless Technologies.
Bluetooth (802.15.1)
Wi-Fi (802.11)
4G Cellular
Typical
...
be sent over the link, as in Table 4.
## 2.7.1 Basic Issues
...
required. Figure 43 gives an example of a
4-bit chipping sequence.
[![../_images/f02-27-9780123850591.png](./images/f02-27-9780123850591.png)
](../_images/f02-27-9780123850591.png)
Figure 43. Example 4-bit chipping sequence.
...
shown in Figure 44. The node at
...
Observe that in Figure 44 we have
...
nodes.
[![../_images/f02-28-9780123850591.png](./images/f02-28-9780123850591.png)
](../_images/f02-28-9780123850591.png)
Figure 44. A wireless network using a base station.
...
[![../_images/f02-29-9780123850591.png](./images/f02-29-9780123850591.png)
](../_images/f02-29-9780123850591.png)
Figure 45. A wireless ad hoc or mesh network.
...
preceding node. This is illustrated in Figure 45. This allows the wireless portion of a network to
...
[![../_images/f02-30-9780123850591.png](./images/f02-30-9780123850591.png)
](../_images/f02-30-9780123850591.png)
Figure 46. The hidden node problem. Although A and C are hidden
from each other, their signals can collide at B. (B’s reach is not
shown.)
Consider the situation depicted in Figure 46,
...
[![../_images/f02-31-9780123850591.png](./images/f02-31-9780123850591.png)
](../_images/f02-31-9780123850591.png)
Figure 47. The exposed node problem. Although B and C are exposed
...
circumstances illustrated in Figure 47,
where each
...
*distribution system*. Figure 48 illustrates
...
[![../_images/f02-32-9780123850591.png](./images/f02-32-9780123850591.png)
](../_images/f02-32-9780123850591.png)
Figure 48. Access points connected to a distribution system.
...
distribution system.
[![../_images/f02-33-9780123850591.png](./images/f02-33-9780123850591.png)
](../_images/f02-33-9780123850591.png)
Figure 49. Node mobility.
Consider the situation shown in Figure 49,
...
Figure 50, is exactly what we would
...
[![../_images/f02-34-9780123850591.png](./images/f02-34-9780123850591.png)
](../_images/f02-34-9780123850591.png)
Figure 50. 802.11 frame format.
...
example given in Figure 48, `Addr1`
...
[
](../_images/f02-35-9780123850591.png)
Figure 51. A Bluetooth piconet.
