...
title: "2.2 Encoding &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.2 Encoding &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation
...
- [Print Copies](../print.html)
      ...
      - 2.2 Encoding
      -
            [ View page source](../_sources/direct/encoding.rst.txt)
        [ Previous](perspective.html)
        [Next ](framing.html)
# 2.2 Encoding
...
bits at the receiving node. Thus, as illustrated in Figure
23, signals travel over a link between two signalling
components, and bits flow between network adaptors.
[![../_images/f02-03-9780123850591.png](./images/f02-03-9780123850591.png)
](../_images/f02-03-9780123850591.png)
Figure 23. Signals travel between signalling components; bits
...
(NRZ).  For example, Figure 24 schematically
depicts the NRZ-encoded signal (bottom) that corresponds to the
transmission of a particular sequence of bits (top).
[![../_images/f02-04-9780123850591.png](./images/f02-04-9780123850591.png)
](../_images/f02-04-9780123850591.png)
...
nothing for consecutive 0s. NRZI is illustrated in Figure 25. An alternative, called *Manchester encoding*, does
...
Manchester encoding is also illustrated in Figure 25. Observe that the Manchester encoding results in 0
...
[![../_images/f02-05-9780123850591.png](./images/f02-05-9780123850591.png)
](../_images/f02-05-9780123850591.png)
...
by the Manchester encoding in Figure 25, then
