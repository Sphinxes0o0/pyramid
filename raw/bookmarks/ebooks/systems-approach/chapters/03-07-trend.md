---
source: https://book.systemsapproach.org/internetworking/trend.html
title: "Perspective: Virtual Networks All the Way Down &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Perspective: Virtual Networks All the Way Down &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Perspective: Virtual Networks All the Way Down — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Perspective: Virtual Networks All the Way Down
      -
            [ View page source](../_sources/internetworking/trend.rst.txt)
        [ Previous](impl.html)
        [Next ](../scaling.html)
# Perspective: Virtual Networks All the Way Down
...
VPNs, as described in [Section 3.3](basic-ip.html#internet-ip),
...
To this end, VLANs, as described in [Section 3.2](ethernet.html#switched-ethernet), are how we typically virtualize an L2 network. VLANs
...
[![../_images/Slide8.png](./images/Slide8.png)
](../_images/Slide8.png)
Figure 96. VXLAN Header encapsulated in a UDP/IP packet.
The actual VXLAN header is simple, as shown in Figure 96. It includes a 24-bit *Virtual Network Id* (VNI), plus
some flag and reserved bits. It also implies a particular setting of
the UDP source and destination port fields (see [Section 5.1](../e2e/udp.html#simple-demultiplexor-udp)), with the destination port 4789
...
[Perspective: The Cloud is Eating the Internet](../scaling/trend.html#perspective-the-cloud-is-eating-the-internet).
To learn more about the maturation of virtual networks, we recommend:
- [Network Virtualiztion Revisited](https://systemsapproach.org/2023/10/16/network-virtualization-revisited/),  2023.
