---
source: https://book.systemsapproach.org/data/multimedia.html
title: "7.2 Multimedia Data &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 7.2 Multimedia Data &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

7.2 Multimedia Data — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 7.2 Multimedia Data
      -
            [ View page source](../_sources/data/multimedia.rst.txt)
        [ Previous](presentation.html)
        [Next ](trend.html)
# 7.2 Multimedia Data
...
each symbol in 5 bits is the best you can do (since 25 = 32
...
than 224, and then picking the 256 colors that most closely
...
[![../_images/f07-11-9780123850591.png](./images/f07-11-9780123850591.png)
...
value for every pixel. Figure 189 illustrates
...
[![../_images/f07-12-9780123850591.png](./images/f07-12-9780123850591.png)
...
component takes place in three phases, as illustrated in Figure
190. On the compression side, the image is fed through these
...
\(x>0\), and \(pixel(x,y)\) is the grayscale value of the pixel
...
Table 24. Example JPEG Quantization Table.
Quantum
3
5
7
...
Table 24. In tables like this one, the low
...
Figure 191. Along this zigzag, a form of run
...
[![../_images/f07-13-9780123850591.png](./images/f07-13-9780123850591.png)
...
[![../_images/f07-14-9780123850591.png](./images/f07-14-9780123850591.png)
](../_images/f07-14-9780123850591.png)
Figure 192. Sequence of I, P, and B frames generated by MPEG.
Figure 192 illustrates a sequence of seven video
...
order.  Instead, the sequence I B B P B B I shown in Figure
192 is transmitted as I P B B I B B. Also, MPEG does not
...
in Figure 193.
[![../_images/f07-15-9780123850591.png](./images/f07-15-9780123850591.png)
...
(\(\delta\)) for each pixel in the macroblock (i.e., how much each
...
pixels. Stated more precisely, if we let Fp and Ff
denote the past and future reference frames, respectively, and the
past/future motion vectors are given by (xp, yp) and
(xf, yf), then the pixel at coordinate *(x,y)* in the current
frame (denoted Fc) is computed as
...
[![../_images/f07-16-9780123850591.png](./images/f07-16-9780123850591.png)
...
Figure 194. (Keep in mind that this figure hides
...
enumerated in Table 25. Of these, Layer III, which is more
...
Table 25. MP3 Compression Rates.
Coding
Bit Rates
Compression Factor
Layer I
