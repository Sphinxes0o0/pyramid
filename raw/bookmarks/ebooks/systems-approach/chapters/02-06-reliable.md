---
source: https://book.systemsapproach.org/direct/reliable.html
title: "2.5 Reliable Transmission &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.5 Reliable Transmission &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation
...
- [Print Copies](../print.html)
      ...
      - 2.5 Reliable Transmission
      -
            [ View page source](../_sources/direct/reliable.rst.txt)
        [ Previous](error.html)
        [Next ](ethernet.html)
# 2.5 Reliable Transmission
...
[![../_images/f02-17-9780123850591.png](./images/f02-17-9780123850591.png)
](../_images/f02-17-9780123850591.png)
Figure 34. Timeline showing four different scenarios for the
...
Figure 34 illustrates timelines for four
...
right, and time flows from top to bottom. Figure 34(a) shows the situation in which the ACK is received
...
Figure 34. In both cases, the sender times
...
illustrated in Figure 35. Thus, when the
...
[![../_images/f02-18-9780123850591.png](./images/f02-18-9780123850591.png)
](../_images/f02-18-9780123850591.png)
Figure 35. Timeline for stop-and-wait with 1-bit sequence
number.
...
two subsections do exactly this. [Next]
## 2.5.2 Sliding Window
...
in Figure 36.
[![../_images/f02-19-9780123850591.png](./images/f02-19-9780123850591.png)
](../_images/f02-19-9780123850591.png)
...
[![../_images/f02-20-9780123850591.png](./images/f02-20-9780123850591.png)
](../_images/f02-20-9780123850591.png)
...
[![../_images/f02-21-9780123850591.png](./images/f02-21-9780123850591.png)
](../_images/f02-21-9780123850591.png)
...
`LFR` to 8, and sets `LAF` to 12.[1] If frame 6 was in fact lost, then
...
thing to do at the link level. [[Next]](../internetworking/basic-ip.html#key-aggregation)
## 2.5.3 Concurrent Logical Channels
