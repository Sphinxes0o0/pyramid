---
source: https://book.systemsapproach.org/applications/infrastructure.html
title: "9.3 Infrastructure Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 9.3 Infrastructure Applications &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

9.3 Infrastructure Applications — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 9.3 Infrastructure Applications
      -
            [ View page source](../_sources/applications/infrastructure.rst.txt)
...
called `HOSTS.TXT`.[1] Whenever a site wanted to add a new host to the
...
case of sending email) in Figure 228. While this picture
makes the name resolution task look simple enough, there is a bit more
to it, as we shall see.
[![../_images/f09-14-9780123850591.png](./images/f09-14-9780123850591.png)
](../_images/f09-14-9780123850591.png)
Figure 228. Names translated into addresses, where the numbers 1 to 5 show the
...
[![../_images/f09-15-9780123850591.png](./images/f09-15-9780123850591.png)
](../_images/f09-15-9780123850591.png)
Figure 229. Example of a domain hierarchy.
...
leaves in the tree correspond to the hosts being named. Figure
229 gives an example of a domain hierarchy. Note that we
should not assign any semantics to the term *domain* other than that it
is simply a context in which additional names can be defined.[2]
[2]
...
subtrees called *zones*. Figure 230 shows how the
hierarchy given in Figure 229 might be divided
...
[![../_images/f09-16-9780123850591.png](./images/f09-16-9780123850591.png)
](../_images/f09-16-9780123850591.png)
Figure 230. Domain hierarchy partitioned into zones.
...
hierarchy of domains, as illustrated in Figure 231.
[![../_images/f09-17-9780123850591.png](./images/f09-17-9780123850591.png)
](../_images/f09-17-9780123850591.png)
Figure 231. Hierarchy of name servers.
...
domain hierarchy given in Figure 229. To
...
interactions illustrated in Figure 232. One
...
[![../_images/f09-18-9780123850591.png](./images/f09-18-9780123850591.png)
](../_images/f09-18-9780123850591.png)
Figure 232. Name resolution in practice, where the numbers 1 to 10 show the sequence
...
addresses in their headers. [[Next]](overlays.html#key-virtualization)
## 9.3.2 Network Management (SNMP, OpenConfig)
...
[![../_images/Slide1.png](./images/Slide1.png)
](../_images/Slide1.png)
Figure 233. Operator manages a network through a configuration and management tool,
...
Figure 233 gives a high-level depiction of this
...
connection. Thus, as depicted in Figure 233, gNMI
