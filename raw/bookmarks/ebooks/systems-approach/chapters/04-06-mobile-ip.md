---
source: https://book.systemsapproach.org/scaling/mobile-ip.html
title: "4.5 Routing Among Mobile Devices &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 4.5 Routing Among Mobile Devices &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

4.5 Routing Among Mobile Devices — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 4.5 Routing Among Mobile Devices
      -
            [ View page source](../_sources/scaling/mobile-ip.rst.txt)
        [ Previous](mpls.html)
        [Next ](trend.html)
# 4.5 Routing Among Mobile Devices
...
you are now. This problem is illustrated in Figure 122; as the mobile node moves from the 802.11 network in
Figure 122(a) to the cellular network in
Figure 122(b), somehow packets from the
*correspondent node* need to find their way to the new network and
then on to the mobile node.
[![../_images/f04-26-22092018.png](./images/f04-26-22092018.png)
](../_images/f04-26-22092018.png)
Figure 122. Forwarding packets from a correspondent node to a
mobile node.
...
home and foreign agents is shown in Figure 123.
[![../_images/f04-27-9780123850591.png](./images/f04-27-9780123850591.png)
](../_images/f04-27-9780123850591.png)
Figure 123. Mobile host and mobility agents.
...
The first problem might look easy if you just look at Figure
123, in which the home agent is clearly the only path between
