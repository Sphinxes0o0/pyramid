---
source: https://book.systemsapproach.org/congestion/issues.html
title: "6.1 Issues in Resource Allocation &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 6.1 Issues in Resource Allocation &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

6.1 Issues in Resource Allocation — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 6.1 Issues in Resource Allocation
      -
            [ View page source](../_sources/congestion/issues.rst.txt)
...
used by many different traffic sources. Figure 152
...
than the simple network depicted in Figure 152,
...
the *bottleneck* router. [[Next]](queuing.html#key-policy-mechanism)
### Connectionless Flows
...
[![../_images/f06-01-9780123850591.png](./images/f06-01-9780123850591.png)
](../_images/f06-01-9780123850591.png)
Figure 152. A potential bottleneck router.
...
abstraction. Figure 153 illustrates several flows
passing through a series of routers.
[![../_images/f06-02-9780123850591.png](./images/f06-02-9780123850591.png)
](../_images/f06-02-9780123850591.png)
Figure 153. Multiple flows passing through a set of routers.
...
queues;[1] real networks have finite buffers and sometimes have to
...
resource allocation mechanism. Figure 154 gives a
...
begins to drop.
[![../_images/f06-03-9780123850591.png](./images/f06-03-9780123850591.png)
](../_images/f06-03-9780123850591.png)
Figure 154. Ratio of throughput to delay as a function of load.
...
Figure 154. Ideally, we would like to avoid the
...
compared? For example, as illustrated in Figure 155, what is fair when one four-hop flow is competing with
three one-hop flows?
[![../_images/f06-04-9780123850591.png](./images/f06-04-9780123850591.png)
](../_images/f06-04-9780123850591.png)
Figure 155. One four-hop flow competing with three one-hop flows.
...
case is
\[\frac{n^2}{n \times n} = 1\]
Now, suppose one flow receives a throughput of \(1 + \Delta\).
Now the fairness index is
\[\frac{((n - 1) + 1 + \Delta)^2}{n(n - 1 + (1 + \Delta)^2)}
= \frac{n^2 + 2n\Delta + \Delta^2}{n^2 + 2n\Delta + n\Delta^2}\]
Note that the denominator exceeds the numerator by \((n-1)\Delta^2\).
Thus, whether the odd flow out was getting more or less than all the
other flows (positive or negative \(\Delta\)), the fairness index has
