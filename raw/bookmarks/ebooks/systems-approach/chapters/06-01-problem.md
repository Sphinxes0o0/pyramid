---
source: https://book.systemsapproach.org/congestion/problem.html
title: "Problem: Allocating Resources &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# Problem: Allocating Resources &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

Problem: Allocating Resources — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - Problem: Allocating Resources
      -
            [ View page source](../_sources/congestion/problem.rst.txt)
        [ Previous](../congestion.html)
        [Next ](issues.html)
# Problem: Allocating Resources
