---
source: https://book.systemsapproach.org/direct/perspective.html
title: "2.1 Technology Landscape &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation"
type: ebook-section
---

# 2.1 Technology Landscape &mdash; Computer Networks: A Systems Approach Version 6.2-dev documentation

2.1 Technology Landscape — Computer Networks: A Systems Approach Version 6.2-dev documentation
      -
          [
...
- [Print Copies](../print.html)
      ...
      - 2.1 Technology Landscape
      -
            [ View page source](../_sources/direct/perspective.rst.txt)
...
[![../_images/f02-01-9780123850591.png](./images/f02-01-9780123850591.png)
](../_images/f02-01-9780123850591.png)
Figure 21. An end-user’s view of the Internet.
Figure 21 illustrates various types of
...
light, to x-rays and gamma rays. Figure 22
depicts the electromagnetic spectrum and shows which media are
commonly used to carry which frequency bands.
[![../_images/f02-02-9780123850591.png](./images/f02-02-9780123850591.png)
](../_images/f02-02-9780123850591.png)
Figure 22. Electromagnetic spectrum.
What Figure 22 doesn’t show is where the
...
ISP, as illustrated in Figure 21. These
link types are summarized in Table 2. They
...
Table 2. Common services available for the last-mile connection to your home.
Service
Bandwidth
DSL (copper)
up to 100 Mbps
