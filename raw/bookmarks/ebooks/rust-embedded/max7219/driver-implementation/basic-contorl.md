# [Basic control](#basic-control){.header}
...
## [Power On and Power Off All Devices](#power-on-and-power-off-all-devices){.header}
...
## [Power On and Power Off a Single Device](#power-on-and-power-off-a-single-device){.header}
...
## [Enable or Disable Display Test Mode](#enable-or-disable-display-test-mode){.header}
...
## [Clear the Display](#clear-the-display){.header}
...
## [Set Intensity (Brightness)](#set-intensity-brightness){.header}
...
## [Set Scan Limit (Digits Visible)](#set-scan-limit-digits-visible){.header}
