...
- [[synthesis/nids-current-architecture]] — NIDS 详细架构分析
- [[synthesis/nids-gap-analysis-roadmap]] — NIDS 功能差距与路线图
- [[synthesis/snort3-deep-architecture]] — Snort3 完整架构文档
- [[synthesis/safeos-vdf-analysis]] — SafeOS VDF 与 NIDS 关系
