...
summary: "abseil C++ Tips of the Week #94: Callsite Readability and bool Parameters."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: 5bfba7d99044fdc0bf3a51da6ade6b1f
---

> 原文：<https://abseil.io/tips/94> · 作者：Abseil Team · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By Geoff Romer [(<span class="__cf_email__" cfemail="0f687d60626a7d4f68606068636a216c6062">\[email protected\]</span>)](/cdn-cgi/l/email-protection#d1b6a3bebcb4a391b6bebeb6bdb4ffb2bebc)*
...
This is much clearer, and much less likely to fall out of sync with the code. [Clang-tidy will even check](https://clang.llvm.org/extra/clang-tidy/checks/bugprone-argument-comment.html) that the comment has the correct parameter name. A less ambiguous but longer variant is to use an explanatory variable:
...
You can also use an `enum class`, as described in [TotW 86](/tips/86), but in that case you’d want to use a slightly different naming convention, e.g.:
