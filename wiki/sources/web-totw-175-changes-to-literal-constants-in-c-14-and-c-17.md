...
summary: "abseil C++ Tips of the Week #175: Changes to Literal Constants in C++14 and C++17.."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: 01e29ff5c59d19ff7d693f4e5ceb096d
---

> 原文：<https://abseil.io/tips/175> · 作者：James Dennett · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By [James Dennett](/cdn-cgi/l/email-protection#2b414f4e45454e5f5f6b4c44444c474e05484446)*
...
Hex floating point literals are indicated by writing a `p` (or `P`) to separate the significand from the exponent—where decimal floating point literals would use `e` (or `E`). For example, `0x2Ap12` is another way to write the value `0x2A << 12`, i.e., 0x2A000, except that is a floating point value, not an integer. As a result, our style guide [requires](https://google.github.io/styleguide/cppguide.html#Floating_Literals) it to be written as `0x2A.0p12` to be explicit that it is a floating point value and not just another way to write an integer.
