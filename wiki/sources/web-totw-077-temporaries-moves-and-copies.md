...
summary: "abseil C++ Tips of the Week #77: Temporaries, Moves, and Copies."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: 487a42dd149102ec9e396f49b6f6eb3d
---

> 原文：<https://abseil.io/tips/77> · 作者：Abseil Team · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By Titus Winters [(<span class="__cf_email__" cfemail="21554855545261464e4e464d440f424e4c">\[email protected\]</span>)](/cdn-cgi/l/email-protection#abdfc2dfded8ebccc4c4ccc7ce85c8c4c6)*
...
You can? Awesome. Remember that the “name rule” means that each unique name you can assign to a certain resource affects how many copies of the object are in circulation. (See [TotW 55](/tips/55) on Name Counting for a refresher.)
...
The other way to tell the compiler that you’re done with a name (the “name eraser” from [TotW 55](/tips/55)) is calling `std::move()`.
