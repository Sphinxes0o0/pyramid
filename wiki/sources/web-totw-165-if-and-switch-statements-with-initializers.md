...
type: source
source-type: web
title: "Tip of the Week #165: `if` and `switch` statements with initializers"
author: "Thomas Köppe"
date: 2012
url: https://abseil.io/tips/165
summary: "abseil C++ Tips of the Week #165: if` and `switch` statements with initializers."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: 428bf5d4355b20c5ec2a0cfd360fc76d
---

> 原文：<https://abseil.io/tips/165> · 作者：Thomas Köppe · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By [Thomas Köppe](/cdn-cgi/l/email-protection#8bffe0e4eefbfbeecbece4e4ece7eea5e8e4e6)*
...
C++17 [allows](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0305r1.html) `if` and `switch` statements to include an initializer:
