...
type: source
source-type: web
title: "Tip of the Week #163: Passing `std::optional` parameters"
author: "Ian Eldred Pudney"
date: 2012
url: https://abseil.io/tips/163
summary: "abseil C++ Tips of the Week #163: Passing `std::optional` parameters."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: b3c0307ba503ecd9cf22a4f9b753ab60
---

> 原文：<https://abseil.io/tips/163> · 作者：Ian Eldred Pudney · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By [Ian Eldred Pudney](/cdn-cgi/l/email-protection#bfcfcadbdbd3daccffd8d0d0d8d3da91dcd0d2)*
...
This will be just as efficient as passing by `const Foo&`, but supports null values. See [Tip \#116](/tips/116) for more on when to use a pointer instead of a const reference.
