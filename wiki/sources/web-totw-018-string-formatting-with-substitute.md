...
summary: "abseil C++ Tips of the Week #18: String Formatting with Substitute."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: 6c99e94787e65f131cda2a7e50adb465
---

> 原文：<https://abseil.io/tips/18> · 作者：Titus Winters · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
*By [Titus Winters](/cdn-cgi/l/email-protection#0d796479787e4d6e7e23786e7f23686978)*
...
As we saw back in [Tip \#3](/tips/3), there are problems with this approach: chains of calls to `operator+()` wind up making (and wasting) temporaries, and cause needless copies of your data.
...
However, an even better option exists: `absl::Substitute()`. `Substitute()` uses the same techniques as `StrCat()` to allow you to pass numeric values, `std::string`s, `char*`s, and `string_view`s. It doesn’t require you to remember arcane format strings for numeric types (or `string_view`).
