...
type: source
source-type: github
title: "Modern C++ Features — C++11"
author: "Anthony Calandra"
date: 2024
path: raw/github/modern-cpp-features/CPP11.md
source-md5: 684f1f454d30d118bcc97b34c930dd6e
size: medium
category: modern-cpp
ingested: 2026-06-07
tool: ingest_github_md.py
summary: "Many of these descriptions and examples are taken from various resources (see [Acknowledgements](#acknowledgements) sec…"
tags: [cpp, modern-cpp, modern-cpp]
created: 2026-06-07
---

# Modern C++ Features — C++11

> Ingested from `raw/github/modern-cpp-features/CPP11.md` (raw .md from `raw/github/...`)
