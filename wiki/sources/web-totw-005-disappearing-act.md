...
summary: "abseil C++ Tips of the Week #5: Disappearing Act."
tags: [cpp, abseil, totw, performance, idioms]
created: 2026-06-10
source-md5: a7ce983809fe5a3145468801a95d9e9a
---

> 原文：<https://abseil.io/tips/5> · 作者：Abseil Team · 发布：2012 · 内容许可：CC BY 4.0（abseil.io docs）
>
...
Because of return value optimization, this usually isn’t any cheaper than storing the object itself (Option 2), and it is potentially confusing or worrisome (see [Tip \#101](/tips/101)). (Exceptional cases that need to use lifetime extension should be commented!)
