...
- [[entities/linux/kernel/net]] — 网络子系统核心框架
- [[entities/linux/kernel/netfilter]] — Netfilter 钩子与 iptables/nftables
- [[entities/linux/network/tcp-sack-dsack]] — TCP SACK/DSACK 实现深度解析

## 来源详情

- [[sources/achieved-tcp-bypass-notes]] — TCP Bypass 超低延迟技术
- [[sources/achieved-bluepuni-blog]] — Caturra's Blog: TCP/packetdrill/内核网络
- [[sources/achieved-linux-packet-flow]] — plantegg: 网络包流转
...
- [[sources/reading-tcp-troubleshooting-plantegg]] — TCP疑难问题：CLOSE_WAIT/queue溢出/TTL fingerprint/ss/netstat
- [[sources/reading-tcp-self-connection-plantegg]] — TCP自连接：simultaneous open/四元组/bind vs connect
- [[sources/reading-linux-advanced-routing-tc]] — Linux高级路由：iproute2/RPDB/qdisc/Netfilter/QoS
- [[sources/reading-linux-tc-traffic-control]] — Linux TC流量控制：netem/tbf/NIDS测试仿真
