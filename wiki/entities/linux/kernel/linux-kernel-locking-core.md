---
type: entity
tags: [linux-kernel, 锁机制, 并发控制, spinlock, mutex, 信号量, lockdep]
created: 2026-05-20
...
- [[entities/linux/kernel/linux-kernel-smp]] — SMP 多核环境下的 spinlock 实现（ticket lock, qspinlock）

## 来源详情
- [[sources/notes-kernel-locking]]
## Related Concepts

- [[entities/linux/kernel/linux-kernel-rcu-core]] — RCU与锁机制同为内核同步原语
- [[entities/linux/kernel/linux-kernel-crypto-core]] — 加解密操作需配合锁机制保证原子性
