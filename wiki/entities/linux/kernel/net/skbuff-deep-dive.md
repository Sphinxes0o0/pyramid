...
- [[entities/linux/kernel/net/linux-kernel-net-subsystem]] — 网络子系统整体架构，SKB 在其中的位置
...
- [[entities/linux/kernel/netfilter/linux-kernel-netfilter-framework]] — Netfilter 通过 SKB 承载数据包
