...
- [[snort3-actions]] — 检测引擎执行动作（alert/drop/pass/log）
- [[snort3-ips-options]] — 检测选项树节点由检测引擎求值
- [[snort3-events-filters]] — 检测引擎通过事件队列输出结果
- [[snort3-flow]] — 检测上下文管理会话状态
- [[snort3-connectors]] — 数据导出动作通过 Connector 发送
- [[snort3-infrastructure]] — MemCapAllocator 等基础设施支持
